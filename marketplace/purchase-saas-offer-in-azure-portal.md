...
- Kullanım Bilgileri + Destek – Yayımcı Kimliği, Teklif Kimliği ve Plan Kimliği'ne dahildir
...
- Teklifinizi Microsoft aracılığıyla satıyorsanız SaaS teklifiniz için önizleme hedef [kitlesi ekleme'ye gidin.](/azure/marketplace/create-new-saas-offer-preview)
- Aksi takdirde [SaaS teklifinizi satma'ya gidin.](/azure/marketplace/create-new-saas-offer-marketing)
