...
### <a name="software"></a>Yazılım
   ...
   Müşteriler, 1 veya 3 yıllık bir dönem için, Azure ayrılmış VM örnekleri üzerinde çalışacak yazılım abonelikleri (Windows Server ve SQL Server için) satın alabilir.
