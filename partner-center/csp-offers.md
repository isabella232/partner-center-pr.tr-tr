...
Henüz Bulut Çözümü Sağlayıcısı Bulut Çözümü Sağlayıcısı? Nasıl [Bulut Çözümü Sağlayıcısı hakkında](https://partner.microsoft.com/cloud-solution-provider) daha fazla bilgi için aşağıdaki web sitesini ziyaret edin. 
...
### <a name="software"></a>Yazılım
   ...
   Müşteriler Yazılım abonelikleri satın alabilir (Azure ayrılmış VM SQL Server çalıştırmak için 1 veya 3 yıllık bir süre boyunca Windows Server ve SQL Server için).
...
### <a name="software-as-a-service-saas-and-other-azure-marketplace-products"></a>Hizmet Olarak Yazılım (SaaS) ve diğer [Azure Market](https://azuremarketplace.microsoft.com/marketplace) ürünleri
   ...
   Bağımsız yazılım satıcıları (ISV) ile SaaS ürünlerine abonelik satabilirsiniz. **Çevrimiçi hizmetlerde** yalnızca SaaS tekliflerini görmek için, bu filtreleri kullanarak **yayımcıyı** **iş ortağı** olarak ayarlayın. Bu, söz konusu müşteri için satın alınabilecek tüm SaaS tekliflerini gösterir.
...
**Yayımcı** -görmek istediğiniz ürün türlerini seçin-Microsoft tarafından veya üçüncü taraf yayımcılar tarafından oluşturulan uygulamalar
...
7. Siparişlerinizi **gözden geçirme sayfasında** ürünleri ve miktarı doğrulayın veya değiştirerek Satın al'ı seçerek siparişi satın alın. 

8. Sipariş numaranız da dahil olmak üzere siparişinizin ayrıntıları sonraki sayfada görüntülenir. **Bitti'yi** seçerek Sipariş **geçmişi sayfanıza** gidin.
