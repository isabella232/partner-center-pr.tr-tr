...
### <a name="software"></a>Yazılım
   ...
   Müşteriler Yazılım abonelikleri satın alabilir (Azure ayrılmış VM Windows SQL Server çalıştırmak için 1 veya 3 yıllık bir süre boyunca Windows Server ve SQL Server için).
...
**Kategori** - Ürünün desteklediği iş türünü ve deneme sürümü olup olmadığını tanımlar
...
>[!NOTE]
>CSP teklifinin hem kiracı ülkede hem de müşterinizin kiracı ülkede kullanılabilir olması gerekir. Örneğin, kiracınız Almanya'da bulunuyorsa ve müşterinin kiracısı Almanya'da bulunuyorsa, dynamics 365 Business Central Premium'i bu müşteriye satamıyoruz çünkü bu teklif şu anda HizmetTele'de mevcut değildir.

1. İş Ortağı Merkezi  menüsünden Müşteriler'i seçin ve ardından satın almak istediğiniz müşteriyi bulun. 
...
4. Aradığınız ürünleri daha kolay bulmak için kullanılabilir filtrelerde ince ayar yapabilirsiniz. Kullanılabilir olanların tam listesini görmek için, uygulanabilir filtreleri herhangi bir olarak **ayarlayın.**
...
- **Tekliflerin fiyat listesinde mevcut olduğundan emin olun**. Kullanılabilir teklif listesi aydan aya değişebilir. Katalogda teklif bulamıyorsanız, Satış ve Fiyatlandırma ve Teklifler sayfasında geçerli fiyat **listelerinde > doğrulayın.**
