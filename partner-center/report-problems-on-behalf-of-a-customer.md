...
3. Müşteri menüsünden Hizmet **istekleri'ne tıklayın.**

4. Yeni **istek açılan** menüsünden platformu seçin. Hizmet isteğini oluşturmak için uygun portala yeniden yönlendiriliyorsınız.

#### <a name="current-view"></a>[Geçerli görünüm](#tab/current-view)

1. İş Ortağı Merkezi [panosunda oturum açın](https://partner.microsoft.com/dashboard) ve İş Ortağı Merkezi **CSP'yi** ve ardından Müşteriler'i **seçin.**
...
2. Destek isteğini uygun bilgilerle doldurun ve Oluştur'a **seçin:**
   ...
   - Destek **isteğinin** Temel bilgiler bölümünde, Destek planı alanında **Bulut Çözümü Sağlayıcısı'yi** **seçin.**
...
1. Müşterinin etki alanı adını hesap sayfasından İş Ortağı Merkezi.
...
Hizmet istekleri dosya aracılığıyla İş Ortağı Merkezi. Bunlar Azure, Microsoft Office 365, Microsoft Dynamics CRM Online ve Enterprise Mobility Suite'Enterprise kullanılabilir. Bulut Çözümü Sağlayıcısı programına katılan bir iş ortağı olarak, başlıca sorunlarınıza öncelik yanıt süresi beklemeniz gerekir.

CsP destek avantajının bir parçası olarak kendi iş ortağı kiracınız için destek dahil değildir. Öte Office 365, Microsoft Dynamics CRM Online ve Enterprise Mobility Suite iş ortakları veya müşteriler için ayrı bir destek aboneliği ücreti ödemez. Azure bir ücret öder, ancak Signature Bulut Desteği veya Microsoft İş Ortağı Ağı (MPN) avantajlarını kullanma yetkisine sahipsiniz, bu avantajları kullanarak bu ücreti ödemeniz gerekir.

Bu avantaj ücretli veya deneme süresinde Bulut Çözümü Sağlayıcısı tüm iş ortakları için geçerlidir. Faturalama ve abonelik yönetimi desteği de bu paketin ücretsiz bir bileşeni olarak dahil edilir.
...
### <a name="what-happens-if-i-sign-into-the-azure-portal-and-bypass-partner-center"></a>Azure portal'da oturum Azure portal atlarsanız ne İş Ortağı Merkezi?

Microsoft Azure portalında doğrudan oturum asanız, merkezi müşterinin bağlamında değil kendi bağlamınız içinde görüntülersiniz. Bu nedenle, kendi abonelikleriniz için bir hizmet isteği oluştururken Microsoft Azure portalda doğrudan oturum açmanız gerekir.
...
Doğrudan yönetim merkezinde Office 365, merkezi müşterinin bağlamında değil kendi bağlamınız içinde görüntülersiniz. Bu nedenle, kendi abonelikleriniz için bir hizmet isteği oluştururken Office 365 yönetim merkezinde doğrudan oturum açmanız gerekir.
