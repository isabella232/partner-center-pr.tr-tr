...
> [!IMPORTANT]
> Tüm yönergeleri dikkatle okuyun ve aşağıdaki tabloda yer alan her sütunun biçimini kontrol edin ve aşağıdaki tabloda CSV dosyalarını kullanarak satış anlaşmalarını İş Ortağı Merkezi.
...
Katılım Kimliği|No|Katılım kimliği Microsoft İş Ortağı Merkezi referans sistemi tarafından oluşturulur. Yeni referans oluşturma için gerekli değildir. Bir kaydı güncelleştiriyorsanız mevcut katılım kimliğini kullanabilirsiniz.|f7eaae47-0b84-4ac4-b4ea-5b2587d42cee
