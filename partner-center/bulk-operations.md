...
description: İş Ortağı Merkezi'de Excel (CSV) dosyalarını kullanarak ortak satış fırsatlarını indirmeyi, oluşturmayı veya İş Ortağı Merkezi
ms.topic: article
...
- Anlaşma ayrıntılarını değiştirmek ve kayıtları güncelleştirmek için karşıya yüklemek üzere indirilen dosyayı yeniden kullanabilirsiniz.
