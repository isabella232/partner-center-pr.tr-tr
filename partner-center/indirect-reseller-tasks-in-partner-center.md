...
CSP programında dolaylı bir satıcı olarak satış için gerekenler hakkında daha fazla bilgi için, [Microsoft iş ortağı ağı Web sitesinde](https://partner.microsoft.com/) [dolaylı bir satıcı olarak çalışmaya başlama](https://partner.microsoft.com/cloud-solution-provider/whats-required) konusuna bakın.
...
5. Şirketinizin yasal iş profilini, birincil iletişim bilgilerini ve müşteri destek bilgilerini sağlayın veya güncelleştirin.
    ...
    Şirket Profilinizi arayabilir veya şirket bilgilerini el ile girebilirsiniz. Şirketiniz Dun & Bradstreet ile kayıtlıysa, şirket bilgilerinizi aramak için DLııD KIMLIĞINI kullanın. Şirket ayrıntılarınızı kendiniz sağlamak istiyorsanız **El Ile gir**' i seçin.
