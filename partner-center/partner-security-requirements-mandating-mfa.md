...
1. [Iş Ortağı Merkezi panosunda](https://partner.microsoft.com/dashboard) genel yönetici veya yönetici Aracısı olarak oturum açın.

2. **Yardım + Destek** kutucuğunu seçin ve ardından **yeni istek**' ı seçin.
...
2. **Destek**' i seçip **iş ortağı destek istekleri**' ni ve ardından **yeni istek**' ı seçerek yeni bir iş ortağı hizmeti isteği oluşturun.
