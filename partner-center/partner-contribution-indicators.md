...
Bu makalede, bir ortağın bulut Business Applications (CBA) MPN uzmanlığına erişme veya sürdürme sürecini değerlendirmek için kullanılan yedi anahtar ortağı katkı göstergelerinin (PCI) her biri açıklanmaktadır.

Makale aşağıdakiler hakkında bilgiler içerir:

- [Her PCI göstergesinin puanlanması](partner-contribution-indicators.md#pci-scoring-based-on-seven-key-indicators)

- [Her PCI göstergesinin eşikleri](partner-contribution-indicators.md#thresholds-for-each-pci-metric)

- [Her PCI göstergesinin ayrıntılı tanımları](partner-contribution-indicators.md#detailed-definitions-of-pci-metrics)

- Iş Ortağı Merkezi 'nde PCI grafiklerine [erişme ve bunları okuma](partner-contribution-indicators.md#how-to-access-and-read-the-charts)

## <a name="overview-of-partner-contribution-indicators"></a>Iş ortağı katkı göstergelerine genel bakış

İş ortağı katkı göstergeleri, bir iş ortağının başarılı müşteri sonuçlarını sunma ve bu nedenle, bir iş ortağı ne zaman ve bulut Business Applications (CBA) MPN uzmanlığına sahip olduğunda pazarda daha fazla farklılık sunan bütünsel bir ölçü sağlar.

PCI sayesinde iş ortakları, başarılı dağıtımlar ve kullanımı artırma gibi müşteri başarısı için kredi alır ve teknik yeteneklerini yatırmaya ve bunları ölçeklendirmeye devam etmek için yeniden çarpıçıkar.

## <a name="pci-scoring-based-on-seven-key-indicators"></a>Yedi anahtar göstergelerine göre PCI Puanlama

PCI, ortağın teknik özelliklerine, müşteri başarısını ve bunların satış performansına yönelik gelişmiş bir görünüm sağlar. PCI, şirketinizin önceki yıllık performansını yedi ana göstergelerden ölçer:
...
### <a name="maximum-scores-you-can-achieve-for-each-indicator"></a>Her gösterge için elde edilebilecek maksimum puan sayısı

Her gösterge toplam 'a eklenen bir puan getirir. Her gösterge için en fazla puan aşağıda verilmiştir:

|Bu gösterge için | En büyük puanınız  |
|:------------|:--------------:|
...
NET yeni gelir bir performans göstergesidir ve [Bu makalede daha önce açıklanan](partner-contribution-indicators.md#pci-scoring-based-on-seven-key-indicators)yedi anahtar ortağı katkı göstergesinden biridir. NET yeni gelirin nasıl tanımlandığı ve noktalarının nasıl hesaplandığı hakkında daha fazla bilgi aşağıda verilmiştir:
...
NET müşteri eklemeleri, [Bu makalede daha önce açıklanan](partner-contribution-indicators.md#pci-scoring-based-on-seven-key-indicators)bir performans göstergesi ve yedi anahtar ortağı katkı göstergesinden biridir. NET Customer eklemeleri hakkında daha fazla bilgi ve bu kategorinin noktalarının nasıl hesaplandığı hakkında daha fazla bilgi bulabilirsiniz:

- NET müşteri eklemeleri, en fazla 10 nokta kazanmasına sahip, sonunda 12 aylık bir dönem boyunca toplanır.
...
İşlevsel danışmanların bir yetenek göstergesi ve [Bu makalede daha önce açıklanan](partner-contribution-indicators.md#pci-scoring-based-on-seven-key-indicators)yedi anahtar ortağı katkı göstergesinden biridir. Aşağıda, işlevsel danışmanların nasıl tanımlandığı ve bu kategorinin noktalarının nasıl hesaplandığı hakkında daha fazla bilgi bulabilirsiniz:
...
Geliştiriciler bir yetenek göstergesidir ve [Bu makalede daha önce açıklanan](partner-contribution-indicators.md#pci-scoring-based-on-seven-key-indicators)yedi anahtar ortağı katkı göstergesinden biridir. Aşağıda, geliştiricilerin göstergesinin nasıl tanımlandığı ve bu kategorinin noktalarının nasıl hesaplandığı hakkında daha fazla bilgi verilmiştir:
...
Yeni büyük dağıtımlar, bir müşteri başarısı göstergesidir ve [Bu makalede daha önce açıklanan](partner-contribution-indicators.md#pci-scoring-based-on-seven-key-indicators)yedi anahtar ortağı katkı göstergesinden biridir. Yeni büyük dağıtımlar göstergesinin nasıl tanımlandığı ve bu kategorinin noktalarının nasıl hesaplandığı hakkında daha fazla bilgi aşağıda verilmiştir:

- Yeni büyük dağıtımlar, en fazla 20 noktası bulunan 12 aylık bir dönemde toplanır.

- Yeni büyük dağıtımlar müşteri katılımı ile finans ve Işlemler için farklı şekilde tanımlanır:
...
- İş ortakları, abonelik düzeyindeki kiracılar ile ilişkilendirilir. Abonelikler, müşteri katılım ürünleriyle veya finans ve operasyon ürünleriyle eşleştirilir.
...
Aylık etkin kullanıcı büyümesi, bir müşteri başarısı göstergesidir ve [Bu makalede daha önce açıklanan](partner-contribution-indicators.md#pci-scoring-based-on-seven-key-indicators)yedi anahtar ortağı katkı göstergesinden biridir. İşte, aylık etkin kullanıcı büyümesinin nasıl tanımlandığı ve bu kategorinin noktalarının nasıl hesaplandığı hakkında daha fazla bilgi bulabilirsiniz:
...
- İş ortakları, abonelik düzeyindeki kiracılar ile ilişkilendirilir. Abonelikler, müşteri katılımı veya finans ve operasyon ürünleriyle eşleştirilir.
...
## <a name="customer-to-partner-association"></a>Müşterinin iş ortağı ilişkilendirmesi

NET yeni gelir, net müşteri ekleme, yeni büyük dağıtımlar ve belirli bir müşteri için aylık etkin kullanıcı büyümesi, ölçüm tanımının sınırları dahilinde, yalnızca bulut çözüm sağlayıcısı (CSP), kayıt ortağı (CPOR) veya müşterinin kiracısına ait ücretli bir abonelik için dijital kayıt ortağı (DPOR) olarak sunulur.

Bir iş ortağı, Dynamics 365 [Online Services Advisor](https://support.microsoft.com/help/4501560/online-services-advisor-osa-sell-incentives-faq) (OSA) teşvik veya Dynamics 365 [Online Services kullanımı](https://support.microsoft.com/help/4489988/online-services-usage-osu-incentives-faq) (OSU) teşvik aracılığıyla abonelik düzeyinde bir müşteriyle ılışkı kurduklarında, cpya dönüşür.

İş ortağı DPOR, ürün içindeki abonelik düzeyinde bir müşteriyle ilişki kurduklarında olur.

Belirli bir abonelik için hem CPOR hem de DPYA da varsa, bu abonelikle ilişkili ilgili PCI ölçümleri için CPOR kredisi alınır. Bu, ilişkinin OSA aracılığıyla olması durumunda CPOR net yeni gelir ve net müşteri için kredi alır. İlişki OSU aracılığıyla olduysa, CPOR yeni büyük dağıtımlar ve aylık etkin kullanıcı büyümesi için kredi alır.

## <a name="how-to-access-and-read-the-charts"></a>Grafiklere erişme ve bunları okuma
...
### <a name="read-the-charts"></a>Grafikleri okuyun

Aşağıdaki görüntüde, Iş Ortağı Merkezi 'nde Iş ortağı katkı göstergeleri sayfasında bazı alanların ve grafiklerin nasıl okunacağı gösterilmektedir.
...
Daha fazla PCI [eğitim videoları ve bilgilendirici kaynakları](https://partner.microsoft.com/asset/collection/pci-learn#/)görüntüleyin.
