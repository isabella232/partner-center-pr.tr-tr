...
Windows Autopilot, müşterileriniz için yönetebileceğiniz cihazlarda Windows özelleştirilmiş yüklemeleri yapılandırmanıza olanak tanır. Müşteri bunu yapma yetkisine sahipse, EULA (Son Kullanıcı Lisans Sözleşmesi) kabul ekranı da dahil olmak üzere, Windows ayarlarken normalde kullanıcılara sunulan bazı ayar ekranlarını gizleyebilirsiniz.
