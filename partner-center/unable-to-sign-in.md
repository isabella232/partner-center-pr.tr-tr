---
title: İş Ortağı Merkezi'de oturum İş Ortağı Merkezi
...
İş Ortağı Merkezi sayfalarına erişim, size atanan roller tarafından denetlenr. Hangi rollerin atandığı kontrol etmek için, İş Ortağı Merkezi simgesini Ayarlar, Hesap ayarları'nın ardından Hesap ayarları'nın altında Kullanıcı **yönetimi'ne tıklayın.** Ara'da, adınız yazın ve sonuçları görüntüden seçin.
