...
1. **Net yeni gelir**: belirli Microsoft ürünlerine yönelik tüm satış kanallarında net yeni gelir. (Bu ölçüm hakkında daha fazla bilgi için bkz. [net yeni gelir Için tanımlar](partner-contribution-indicators-small-and-midmarket-cloud-business-option.md#definitions-for-pci-metric-1---net-new-revenue).)

2. **Net müşteri eklemeleri**: tüm satış kanallarında belirli Microsoft ürünleri için alınmış net müşteriler. (Bu ölçüm hakkında daha fazla bilgi için bkz. [net Customer eklemeleri Için tanımlar](partner-contribution-indicators-small-and-midmarket-cloud-business-option.md#definitions-for-pci-metric-2---net-customer-adds).)
...
4. **Geliştiriciler**: Şu anda etkin olan bir geliştiriciyi tutan kişilerin sayısı, Dynamics 365 Için sertifikayı ilişkilendirir. (Bu ölçüm hakkında daha fazla bilgi için bkz. [geliştiriciler Için tanımlar](partner-contribution-indicators-small-and-midmarket-cloud-business-option.md#definitions-for-pci-metric-4---developers).)

*Müşteri başarı göstergeleri:*

5. **Yeni dağıtımlar**: son 12 ay boyunca belirli bir kullanım eşiğini aşan üretim kiracılarının sayısı. (Bu ölçüm hakkında daha fazla bilgi için bkz. [Yeni dağıtımlar Için tanımlar](partner-contribution-indicators-small-and-midmarket-cloud-business-option.md#definitions-for-pci-metric-5---new-deployments).)
...
Dynamics 365 Online Services Advisor (OSA) teşviki veya Dynamics 365 Online Services Kullanımı (OSU) teşviki aracılığıyla bir müşteriyle abonelik düzeyinde ilişki kuran bir iş ortağı CPOR olur.
...
- İşlev danışmanları, Customer Engagement İşlev Danışmanı sertifikası veya Finance and Operations İşlev Danışmanı sertifikası gibi şu anda etkin olan İşlev Danışmanı İş Ortağı sertifikasına sahip kişi sayısı olarak tanımlanır.
...
- Bu uzmanlık seçeneği için maksimum puan kazanmak için, iş ortaklarının son 12 ay içinde her kiracının **aylık 5** etkin kullanıcı eşiğini aşarak **10** üretim kiracısı olması gerekir.
...
- İş ortakları, abonelik düzeyinde kiracılarla ilişkilendirilmektedir. Abonelikler aşağıdaki, uygun ürünlerle eşlenir:
...
- Bir kiracı kapsamındaki tüm ücretli abonelikle ilişkili tüm iş ortakları, bu kiracının altındaki tüm üretim örnekleri için kredi alır. 
...
- İş ortakları, abonelik düzeyindeki kiracılar ile ilişkilendirilir. Abonelikler, uygun ürünlerle eşleştirilir.

- Bir kiracı kapsamındaki tüm ücretli abonelikle ilişkili tüm iş ortakları, bu kiracı kapsamındaki tüm ücretli abonelikler arasında toplanan tüm aylık etkin kullanıcılar için kredi alır.
