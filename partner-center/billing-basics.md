...
3. Faturalama geçmişi bölümünde en son faturanızı indirin veya önceki **faturalarınızı** indirin.
...
**Tek sefer faturalama:** Ağustos 2021'den itibaren geçerli olacak şekilde, ürünleri sattığınız müşterinin konumu ne olursa olsun tüm iş ortakları iş ortağı konumu para birimi cinsinden faturalandırılacaktır. Onetime ve [yinelenen hakkında daha fazla bilgi okuyun.](azure-plan-billing.md)
...
En son Bulut Çözümü Sağlayıcısı ve teklifleri görmek için, İş Ortağı Merkezi panosundan Fiyatlandırma **kutucuğunu** seçin. Kullanılabilir farklı ürün türleri için ayrı fiyat listeleri bulabilirsiniz. Aşağıdaki fiyat listeleri Fiyat listeleri **sayfasında** mevcuttur:
...
**Ürün, hizmet ve yazılım abonelikleri için fiyatlar,** abonelik süresi boyunca garanti altına alınmaktadır. Ancak, yenilemiyorken fiyatlar değişebilir.
...
İki tür faturalama sıklığı vardır: yıllık ve aylık. Tarifeli hizmet fiyatları fatura döngüsü içinde değişebilir.
...
- Fatura oluşturulduktan sonra bir vergi iadesi uygulandı. Vergi iadesini özgün faturaya geri almak için kredi veya yeniden ödeme isteği alabilirsiniz. Para iadeleri için de aynı durum aynıdır. Özgün faturanın iadesini veya faturasını iade isteğinde bulundurarak para iadesi alabilirsiniz.

**Tek seferlik ve yinelenen tüm işlemler için,** Microsoft bir kredi veya yeniden ödeme isteğiniz olduğunda bir kredi notu kullanabilir. Fatura, kredinin iptal edilmesiyle iptal edilir.
