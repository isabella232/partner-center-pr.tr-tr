...
3. En son faturanızı indirin veya **Faturalama geçmişi** bölümünde önceki faturaları indirin.
...
en son Bulut Çözümü Sağlayıcısı programları ve teklifleri görmek için, iş ortağı merkezi panosundan **fiyatlandırma** kutucuğunu seçin. Kullanılabilir farklı ürün türleri için ayrı fiyat listeleri bulacaksınız. **Fiyatlandırma ve teklifler** sayfasında aşağıdaki fiyat listeleri mevcuttur:
...
İki tür faturalandırma sıklığı vardır: yıllık ve aylık. Ölçülen hizmet ücretleri, fatura döngüsünün içinde değişebilir.
...
- Ödemeler, satılan lisanslar için faturalandırılır, lisans sağlanmamıştır.
