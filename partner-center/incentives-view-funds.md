...
Teşvik işbirliği fonlarınızı panoda izleyebilir, izleyebilir ve muuzlaştırabilirsiniz [(oturum](https://partner.microsoft.com/dashboard/) İş Ortağı Merkezi gerekir). Bu fonlarını görüntülemek için aşağıdaki yordamı kullanın.
...
5. Seçilen dönemin sona erme tarihi, Kalan ortak **çalışma görüntüsü altında** görünür.  
...
1. Azure AD [hesabınızla (şirket İş Ortağı Merkezi)](https://partner.microsoft.com/dashboard/) veya teşvik rolünüz için uygun e-posta ile panoda oturum açın.
