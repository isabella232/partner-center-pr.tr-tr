...
1. Ortak Merkezi ve Microsoft İş Ortağı Ağı (MPN) KIMLIĞINDEKI iş ortağı profillerinizin güncel olduğundan emin olun.

2. Dolaylı satıcıya geçiş yaptığınız doğrudan fatura kiracının genel yöneticisi olarak [Iş Ortağı Merkezi panosunda](https://partner.microsoft.com/dashboard) oturum açın.

3. Kayıt formunda iş ortağı ayrıntılarınızı gözden geçirin.

   :::image type="content" source="images/direct/direct2a.png" alt-text="Kayıt düğmesini gösteren ekran görüntüsü.":::
...
>[!NOTE]
>Korumalı alan özellikleri yalnızca doğrudan fatura ortakları tarafından kullanılabilir. Doğrudan faturanızda dolaylı satıcıya geçiş yaptıktan sonra, korumalı alan özelliklerine erişiminizi kaybedersiniz.
...
7. Uygun şekilde **kabul et** veya **Reddet** ' i seçin.
...
Geçiş ortağı aşağıdakileri yapması gerekir:
...
6. Aboneliğin artık **abonelikler** sayfasında etkin olarak görünmediğini doğrulayın:
   ...
   - Bu bir Azure aboneliğse (MS-AZR-0145P), artık listelenmez.

   - bu bir lisans tabanlı abonelik (Office 365, Dynamics, ıntune) ise, durumu **askıya alındı** olarak listelenir.

   :::image type="content" source="images/direct/direct13.png" alt-text="Abonelik askıya alındı.":::

### <a name="considerations"></a>Dikkat edilmesi gerekenler

- **Abonelik KIMLIĞI aktarımdan sonra farklı olacaktır.** Bu bir Azure aboneliği (MS-AZR-0145P) ise, buna ek olarak, önceki sahip tarafından korunacak ve Azure yönetim portalında görünecek bir Azure Abonelik Kimliğine sahip olur.
