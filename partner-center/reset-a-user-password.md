...
description: İş Ortağı Merkezi'da kullanıcı parolasını sıfırlamayı İş Ortağı Merkezi. Kullanıcılar, oturum açmaları için bir sonraki oturum açma İş Ortağı Merkezi.
...
> [!NOTE]  
> Microsoft Bulut Almanya'da Bulut Çözümü Sağlayıcısı (CSP) programına kaydolduysanız, bir kullanıcının parolasını sıfırlama hakkında bilgi için bkz. [Microsoft Bulut](user-management-in-partner-center-for-microsoft-cloud-germany.md) İş Ortağı Merkezi için İş Ortağı Merkezi'de kullanıcı yönetimi.
