...
**S: Uzmanlıklar yenilenmekte olan işlem ve zamanlama nedir?**

Y: şirketiniz, Iş Ortağı Merkezi 'nde bir uzmanlığa göre yenilenebilir. Uzmanlığa yönelik performans gereksinimlerini karşılamanız, her yıl gereken sınavları ve becerileri doğrulamanız ve uzmanlık durumunu ve ilgili avantajlara erişim sağlamak için yenileme penceresindeki yıllık ücreti ödemeniz gerekir.
...
## <a name="product-licenses"></a>Ürün lisansları

**S: ürün lisanlarındaki Microsoft İş Ortağı Ağı iş ortakları için geçerli teklifler nelerdir?**

Y: ürün lisansları (iç kullanım lisansları veya iç kullanım hakları olarak da bilinir), uzmanlığa veya Microsoft Eylem Paketi satın alan iş ortaklarının avantajlarına dahildir. [Microsoft iş ortağı ağı programları kılavuzlarından](https://aka.ms/partner-benefits-use-guide)geçerli ürün lisansı tekliflerinin bir listesini alın.

**S: birden çok aboneliğin kilidini açmaya yönelik tek bir belirteç kullanılabilir mi?**

Y: Hayır, birden çok aboneliğin kilidini açmak için belirteçleri bölemezsiniz. Belirteçlerin, belirtilen biçimde kullanılması gerekir. Örneğin, 25 koltuk belirteç 5 farklı 5-koltuk belirtecine bölünemiyor.

Daha fazla bilgi için lütfen Microsoft Iş ortağı programları Kılavuzu [aka.MS/partner-Benefits-Use-Guide](https://aka.ms/partner-benefits-use-guide) inceleyin.

**S:** **bulut hizmetleri için belirtecimizi yanlış bir kiracıda etkinleştirdik veya genişletme yerine bir bilgisayar adına sunduk, değiştirme belirtecini alabilir miyim?**

Y: bulut hizmeti etkinleştirmeleri için yanlış kiracıya yönelik değiştirme belirteçleri ve mevcut aboneliklerde yanlışlıkla eklenen bir bilgisayar varsa, özgün belirtecin etkinleştirilmesinden sonraki 30 gün içinde yalnızca bir kerelik olarak verilebilir.

Daha fazla bilgi için lütfen Microsoft Iş ortağı programları Kılavuzu [aka.MS/partner-Benefits-Use-Guide](https://aka.ms/partner-benefits-use-guide) inceleyin.

**S: şirket içi yazılım ürün lisansları Için, yükleme için bir ürün anahtarı olması gerekiyor mu?**

Y: tüm ürünler bir ürün anahtarı gerektirmez. Windows Server ve istemci işletim sistemleri ve tüm Microsoft Office istemci uygulamaları için ürün etkinleştirme gereklidir.
...
A. İş ortakları için bir veya daha fazla Uzmanlıklar içeren Microsoft İş Ortağı Ağı veya Microsoft Eylem Paketi satın alıp Microsoft ürünlerini ve teknolojileri hakkında bilgi sahibi olmaya yönelik ürün lisansları ekledik. Uzmanlığa ve Eylem Paketi dahil olan ürün lisansları için kullanım koşulları [Microsoft iş ortağı ağı programlar kılavuzunda](https://aka.ms/partner-benefits-use-guide)açıklanmaktadır.

**Ç.** **Şirketitim veya eylem paketi konusunda bize ait Ürün lisanslarını** **nasıl kullanabileceği hakkında sınırlamalar var** mı?

A. Evet, sınırlamalar var. Ürün Lisansı kullanım koşulları, Microsoft lisanslama programları aracılığıyla elde edilen ticari lisanslardan farklıdır. Daha fazla bilgi için [ürün lisanslama kullanım koşulları](https://www.microsoft.com/licensing)makalesini okuyun.
Ürün lisansları yazılım güvencesi içermez ve ürün lisanslarında bazı kısıtlamalar vardır. [Microsoft iş ortağı ağı programları kılavuzundaki](https://aka.ms/partner-benefits-use-guide)ürün lisansları için kullanım koşullarını inceleyebilirsiniz.

**Ç.** **Şirketimizin kapsanmasını** **sağlamak Için iş ortağı merkezi 'Nde listelenenlere nasıl daha fazla ürün lisansı ekleyebilirim** ?

A. Eylem Paketi uzmanlığın yanı sıra ürün lisansları, Microsoft lisanslama programları aracılığıyla elde edilen ticari lisanslardan farklı kullanım koşullarına sahiptir. Şirketinizin lisanslama ihtiyaçlarını [Microsoft lisanslama](https://www.microsoft.com/licensing)'de toplantıya yönelik seçeneklerinizi gözden geçirmeyi öneririz.
