...
## <a name="enroll-with-the-learning-action-pack"></a>Öğrenme Eylem Paketi kaydetme

Öğrenme Eylem Paketi, öğrenme Iş ortağı programına temel düzey giriştir. Eğitim iş kolu hakkında yeni başladıysanız ve kuruluşunuzun daha önce herhangi bir Microsoft kurs eğitimi yapmadıysanız, Microsoft size bu fırsatı Microsoft Learning Iş ortağı olarak kaydetmek için size sunar. Öğrenimi Eylem Paketi satın almanız yeterlidir.
...
- Iş Ortağı Merkezi 'nde öğrenimi Eylem Paketi uygun hale getirmek için en az bir (1) MCT olmalıdır. Diğer bir öğrenme KPI 'Larını karşılamanız gerekmez.
- Öğrenimi Eylem Paketi etkinleştirmek için aşağıdaki adımları kullanın:
...
### <a name="q-do-i-need-to-submit-a-business-application-plan-in-partner-center-to-enroll-in-a-learning-option"></a>S. Bir öğrenme seçeneğine kaydolmak için Iş Ortağı Merkezi 'ne bir Iş uygulaması planı göndermem gerekir mi?

Hayır. Iş Ortağı Merkezi 'nde, öğrenme seçeneği aracılığıyla bir uzmanlığa ulaşmak için Iş uygulaması planının gerekli değildir. Kayıt 'nın ilk yılından öğrenme KPI 'Larını karşılamanız gerekir.

### <a name="q-if-i-am-a-net-new-partner-and-decide-to-buy-courseware-trainings-or-certifications-before-applying-for-the-learning-option-will-the-kpis-be-recognized-by-partner-center-automatically"></a>S: bir net-yeni iş ortağıysam ve öğrenme seçeneğine uygulamadan önce kurs, eğitim veya sertifika satın almaya karar verdim, KPI 'Lar Iş Ortağı Merkezi tarafından otomatik olarak tanınacaktır mi?

Evet, KPI 'Lar Iş Ortağı Merkezi 'nde tanınmalıdır.

### <a name="q-where-should-i-go-in-case-there-is-a-discrepancy-between-kpis-in-partner-center-under-the-learning-option-and-my-kpi-dashboard"></a>S. Eğitim seçeneği ve KPI panoum altında Iş Ortağı Merkezi 'nde KPI 'ler arasında bir tutarsızlık olması durumunda nereden gideceğim?
