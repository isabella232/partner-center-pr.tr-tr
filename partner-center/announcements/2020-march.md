...
description: Microsoft İş Ortağı Merkezi için Yeni özellikler, promosyonlar, teklifler, pazarlar veya mevcut tekliflerde yapılan değişiklikler gibi Mart 2020 duyuruları.
ms.topic: article
...
## <a name="microsoft-will-rename-office-365-small-and-medium-business-smb-offers-from-april-21-2020"></a><a id="7"/></a>Microsoft, küçük Office 365 orta ölçekli işletme (SMB) tekliflerini 21 Nisan 2020'den itibaren yeniden adlandıracak
...
- Office 365 İş bir İş için Microsoft 365 Uygulamaları
- Office 365 ProPlus bir Kurumlar için Microsoft 365 Uygulamaları

### <a name="impact-on-your-operations"></a>İşlemlerinizi etkileme

Fiyatlarda, özelliklerde veya iş modelinde değişiklik yoktur. SKUS'larda ve SKUS'Office 365 Kurumsal adlandırma Microsoft 365 Kurumsal yoktur. Tüm SKU ve teklif yeniden adlarına otomatik olarak abonelik adlarına İş Ortağı Merkezi.
...
- [Bulut Çözümü Sağlayıcısı (CSP) doğrudan fatura iş ortağından CSP dolaylı](../transition-direct-to-indirect.md#move-your-direct-bill-customers-to-your-indirect-provider) kurumsal bayi yardım makalesine geçiş
...
## <a name="new-microsoft-365-entry-level-sku-for-firstline-workers---csp"></a><a id="5"/></a>İlk Microsoft 365 için giriş düzeyi SKU'ya yeni giriş - CSP
...
**Yeni giriş düzeyinde SKU:** Yeni giriş düzeyinde SKU, Microsoft 365 F1 olarak çağrılır ve İlk Satır Çalışanları, genişletilmiş güvenlik ve kimlik değerine uyarlanmış değeri tüm çalışanlara sunacak. Bu teklif Teams, SharePoint Online, Yammer Enterprise, Stream, EMS E3 ve Office Web/Mobile Apps.

Bu değişiklikler, Birinci Satır Çalışanları için daha iyi değer sağlar ve iş ortaklarının önemli bir kullanıcı büyüme fırsatına dokunmasına olanak sağlar.
...
- Lütfen bu bilgileri, kuruluşta uygun kişiler ile paylaşın.<br>
...
Microsoft, E3 Windows ön gereksinimini Microsoft Defender Gelişmiş Tehdit Koruması MDATP'den kaldırarak desteklenen tüm istemci cihazları için MDATP'ye izin verir.
...
Microsoft, E3 Windows ön gereksinimini Microsoft Defender Gelişmiş Tehdit Koruması (MDATP) ortadan kaldırdı. CSP iş ortakları, E3 lisans sahiplik durumuna bakılmaksızın desteklenen tüm istemci cihazları için MDATP Windows satın aabilecektir.

Microsoft, bu iş modelini etkinleştirmek için CSP için tek başına bir teklif başlattı ve artık kullanılabilir.

Ayrıca, MDATP de dahil olmak üzere Windows E5, Microsoft 365 E5 Güvenlik ve Microsoft 365 E5 tekliflerde değişiklik olmaz.
