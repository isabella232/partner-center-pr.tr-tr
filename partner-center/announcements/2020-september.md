...
### <a name="impacted-audience"></a><span data-ttu-id="1b221-110">Etkilenen hedef kitle</span><span class="sxs-lookup"><span data-stu-id="1b221-110">Impacted audience</span></span>
...
<span data-ttu-id="1b221-123">**Microsoft 365 Yönetim Merkezi**</span><span class="sxs-lookup"><span data-stu-id="1b221-123">**Microsoft 365 Admin Center**</span></span>
...
### <a name="change-log"></a><span data-ttu-id="1b221-133">Değişiklik günlüğü:</span><span class="sxs-lookup"><span data-stu-id="1b221-133">Change Log:</span></span>
...
### <a name="change-log"></a><span data-ttu-id="1b221-157">Değişiklik günlüğü:</span><span class="sxs-lookup"><span data-stu-id="1b221-157">Change Log:</span></span>
...
<span data-ttu-id="1b221-170">Geçiş Aracı, Azure için yeni ticaret deneyimini genişlettikten sonra Azure aboneliklerini yönetme ve müşterilerin gelişen iş ihtiyaçlarını destekleme esnekliğini aşağıdaki avantajlarla geliştirir:</span><span class="sxs-lookup"><span data-stu-id="1b221-170">Expanding on the new commerce experience for Azure, the transition tool enhances the flexibility to manage Azure subscriptions and support customers’ evolving business needs with the following benefits:</span></span>  
...
### <a name="categories"></a><span data-ttu-id="1b221-184">Kategoriler</span><span class="sxs-lookup"><span data-stu-id="1b221-184">Categories</span></span>
...
### <a name="testing"></a><span data-ttu-id="1b221-197">Test Etme</span><span class="sxs-lookup"><span data-stu-id="1b221-197">Testing</span></span> 
...
## <a name="next-steps"></a><span data-ttu-id="1b221-210">Sonraki adımlar</span><span class="sxs-lookup"><span data-stu-id="1b221-210">Next steps</span></span>
...
- <span data-ttu-id="1b221-219">Tarih: 2020-09-29</span><span class="sxs-lookup"><span data-stu-id="1b221-219">Date: 2020-09-29</span></span>
...
3.  <span data-ttu-id="1b221-232">[Iş ortağı lisans kullanım bilgileri API 'si](/partner-center/develop/get-partner-licenses-usage-information).</span><span class="sxs-lookup"><span data-stu-id="1b221-232">[Partner license usage information API](/partner-center/develop/get-partner-licenses-usage-information).</span></span>
...
### <a name="summary"></a><span data-ttu-id="1b221-253">Özet</span><span class="sxs-lookup"><span data-stu-id="1b221-253">Summary</span></span> 
...
### <a name="next-steps"></a><span data-ttu-id="1b221-264">Sonraki Adımlar:</span><span class="sxs-lookup"><span data-stu-id="1b221-264">Next Steps:</span></span>
...
<span data-ttu-id="1b221-279">**Myınsights** , 30 Eylül 2020 ' den sonra artık kullanılamayacak.</span><span class="sxs-lookup"><span data-stu-id="1b221-279">**MyInsights** will no longer be available after September 30, 2020.</span></span> 
...
- <span data-ttu-id="1b221-290">Bu yeni özellikleri araştırmanızı ve Öngörüler sekmesinden sunulan satır içi geri bildirim araçlarını kullanarak geri bildiriminizi paylaşmanızı öneririz.</span><span class="sxs-lookup"><span data-stu-id="1b221-290">We encourage you to explore these new capabilities and share your feedback using the inline feedback tools available in the Insights tab.</span></span>
...
- <span data-ttu-id="1b221-303">Denetim kaydı için desteklenen işlem türlerini güncelleştirin.</span><span class="sxs-lookup"><span data-stu-id="1b221-303">Update supported operation types for Audit Record.</span></span> <span data-ttu-id="1b221-304">Yeni eklenen olanlar [Denetim kaynaklarında](/partner-center/develop/auditing-resources) listelenir</span><span class="sxs-lookup"><span data-stu-id="1b221-304">The newly added ones are listed at [Auditing resources](/partner-center/develop/auditing-resources)</span></span>
...
### <a name="categories"></a><span data-ttu-id="1b221-320">Kategoriler</span><span class="sxs-lookup"><span data-stu-id="1b221-320">Categories</span></span>
...
<span data-ttu-id="1b221-344">İş ortaklarının O365 kullanımını ölçmesine yardımcı olmak için, CSP O365 kullanım API 'Lerinde güncelleştirmeler yapılır.</span><span class="sxs-lookup"><span data-stu-id="1b221-344">Updates will be made to the CSP O365 usage APIs to help partners measure their O365 usage.</span></span>
...
### <a name="next-stepsadditional-resources"></a><span data-ttu-id="1b221-356">Sonraki adımlar/ek kaynaklar:</span><span class="sxs-lookup"><span data-stu-id="1b221-356">Next Steps/Additional Resources:</span></span>
...
- [<span data-ttu-id="1b221-392">29 Eylül 8:30 Pasifik saati</span><span class="sxs-lookup"><span data-stu-id="1b221-392">September 29 at 8:30 AM Pacific Time</span></span>](https://teams.microsoft.com/l/meetup-join/19%3ameeting_ZTdiMGNhMmMtYjkwZi00MTE0LWE3MDYtOWFlNDhiNjkwNDc1%40thread.v2/0?context=%7b%22Tid%22%3a%2272f988bf-86f1-41af-91ab-2d7cd011db47%22%2c%22Oid%22%3a%227014dada-1df3-405c-93ee-588d8ae65a53%22%2c%22IsBroadcastMeeting%22%3atrue%7d)
...
1. <span data-ttu-id="1b221-395">Iş ortağı merkezindeki bir hesapla ve MPA kabul durumundaki dolaylı satıcılarınızın ayrıntılarını görüntülemek için MPA raporuna erişin.</span><span class="sxs-lookup"><span data-stu-id="1b221-395">Access the MPA report to view details of your indirect resellers with an account in Partner Center and their MPA acceptance status.</span></span> <span data-ttu-id="1b221-396">Raporu görüntülemek için Iş Ortağı Merkezi ' nde oturum açın ve Sol menüdeki **Çözümle/satıcı analizi** ' ne gidin.</span><span class="sxs-lookup"><span data-stu-id="1b221-396">To view the report, sign in to Partner Center and navigate to **Analyze / Reseller Analytics** in the left menu.</span></span>

2. <span data-ttu-id="1b221-397">Sağ taraftaki indir simgesine tıklayarak raporu indirin.</span><span class="sxs-lookup"><span data-stu-id="1b221-397">Download the report by clicking on the download icon on the right-hand side.</span></span>
3. <span data-ttu-id="1b221-398">Boş bir Excel dosyası açın ve indirilen ". tsv" dosyasını Excel dosyasına sürükleyin.</span><span class="sxs-lookup"><span data-stu-id="1b221-398">Open a blank Excel file and drag the downloaded ".tsv" file onto the Excel file.</span></span>

<span data-ttu-id="1b221-399">Note: dolaylı satıcınızdan MPA 'yı aynı bölgede kabul etmiş en az bir kiracı varsa, başka bir eylem gerekmez.</span><span class="sxs-lookup"><span data-stu-id="1b221-399">Note: If your indirect reseller has at least one tenant that has accepted the MPA within the same region, no further action is required of them.</span></span> 

________________

## <a name="self-service-purchasing-for-microsoft-project-and-microsoft-visio-now-available"></a><a name="6"></a><span data-ttu-id="1b221-400">Microsoft Project ve Microsoft Visio için self servis satın alma artık kullanıma sunuldu</span><span class="sxs-lookup"><span data-stu-id="1b221-400">Self-service purchasing for Microsoft Project and Microsoft Visio now available</span></span>

### <a name="categories"></a><span data-ttu-id="1b221-401">Kategoriler</span><span class="sxs-lookup"><span data-stu-id="1b221-401">Categories</span></span>

- <span data-ttu-id="1b221-402">Tarih: 2020-09-15</span><span class="sxs-lookup"><span data-stu-id="1b221-402">Date: 2020-09-15</span></span>
- <span data-ttu-id="1b221-403">Teklifler/Pazarlar</span><span class="sxs-lookup"><span data-stu-id="1b221-403">Offers/Markets</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="1b221-404">Etkilenen hedef kitle</span><span class="sxs-lookup"><span data-stu-id="1b221-404">Impacted audience</span></span>

<span data-ttu-id="1b221-405">Ticari müşterilere çevrimiçi hizmetler satan iş ortakları</span><span class="sxs-lookup"><span data-stu-id="1b221-405">Partners selling online services to commercial customers</span></span>

### <a name="details"></a><span data-ttu-id="1b221-406">Ayrıntılar</span><span class="sxs-lookup"><span data-stu-id="1b221-406">Details</span></span>

<span data-ttu-id="1b221-407">Geçen yıl, Microsoft 'un bireyleri ve ekiplerin doğrudan Select hizmetleri satın almasını olanaklı olduğunu [biliyoruz](https://partner.microsoft.com/resources/detail/power-apps-power-automate-self-service-pdf) .</span><span class="sxs-lookup"><span data-stu-id="1b221-407">Last year we [let you know](https://partner.microsoft.com/resources/detail/power-apps-power-automate-self-service-pdf) that Microsoft is enabling individuals and teams to purchase select services directly.</span></span> <span data-ttu-id="1b221-408">Artık dünya çapındaki kişiler aşağıdaki Microsoft Project ve Microsoft Visio ürünleri için self servis aracılığıyla abonelikler satın alabilir:</span><span class="sxs-lookup"><span data-stu-id="1b221-408">Now individuals worldwide can purchase subscriptions for the following Microsoft Project and Microsoft Visio products through self-service:</span></span> 

- <span data-ttu-id="1b221-409">[Visio plan 1](https://products.office.com/visio/visio-plan-1?activetab=pivot:overviewtab) ve [Visio planı 2](https://www.microsoft.com/microsoft-365/visio/visio-plan-2?rtc=2&SilentAuth=1&activetab=pivot:overviewtab)</span><span class="sxs-lookup"><span data-stu-id="1b221-409">[Visio Plan 1](https://products.office.com/visio/visio-plan-1?activetab=pivot:overviewtab) and [Visio Plan 2](https://www.microsoft.com/microsoft-365/visio/visio-plan-2?rtc=2&SilentAuth=1&activetab=pivot:overviewtab)</span></span>
- <span data-ttu-id="1b221-410">[Proje planı 1](https://www.microsoft.com/microsoft-365/project/project-plan-1?rtc=1&activetab=pivot:overviewtab) ve [Proje planı 3](https://www.microsoft.com/microsoft-365/project/project-plan-3?rtc=1&activetab=pivot:overviewtab)</span><span class="sxs-lookup"><span data-stu-id="1b221-410">[Project Plan 1](https://www.microsoft.com/microsoft-365/project/project-plan-1?rtc=1&activetab=pivot:overviewtab) and [Project Plan 3](https://www.microsoft.com/microsoft-365/project/project-plan-3?rtc=1&activetab=pivot:overviewtab)</span></span>

<span data-ttu-id="1b221-411">Note: Self servis satın alma özellikleri şu anda Hindistan, Brezilya, Kongo Demokratik Cumhuriyeti (KDC) veya kamu veya eğitim teklifleri için uygun olan müşteriler için kullanılabilir değildir.</span><span class="sxs-lookup"><span data-stu-id="1b221-411">Note:  Self-service purchase capabilities aren’t currently available in India, Brazil, Democratic Republic of Congo (DRC), or to customers who are eligible for Government or Education offers.</span></span>  <span data-ttu-id="1b221-412">Tam ülke kullanılabilirliği ve güncelleştirmeleri için [self servis satın alma hakkında SSS bölümüne](/microsoft-365/commerce/subscriptions/self-service-purchase-faq?preserve-view=true&view=o365-worldwide) bakın.</span><span class="sxs-lookup"><span data-stu-id="1b221-412">Check the [self-service purchase FAQ](/microsoft-365/commerce/subscriptions/self-service-purchase-faq?preserve-view=true&view=o365-worldwide) for full country availability and updates.</span></span>

#### <a name="partner-benefits"></a><span data-ttu-id="1b221-413">İş ortağı avantajları</span><span class="sxs-lookup"><span data-stu-id="1b221-413">Partner benefits</span></span>

<span data-ttu-id="1b221-414">Gerekli lisansları elde etmek üzere merkezi bir BT satın alma süreci aracılığıyla hizmetlerinizi bireyler ve takımlar için sunabileceksiniz.</span><span class="sxs-lookup"><span data-stu-id="1b221-414">You’ll be able to offer your services to individuals and teams without needing to go through a centralized IT procurement process to obtain required licenses.</span></span> <span data-ttu-id="1b221-415">Hizmetleriniz, Microsoft 365 ve güç platformuyla tümleştirme senaryolarına bağlı olarak Project ve Visio 'a yayılabilir.</span><span class="sxs-lookup"><span data-stu-id="1b221-415">Your services can span Project and Visio, based on integration scenarios with Microsoft 365 and Power Platform.</span></span> <span data-ttu-id="1b221-416">Müşteriler ayrıca Visio [planı 1 ve Visio plan 2](https://partner.microsoft.com/resources/collection/visio-availability-announcing-trial-offers#/)ve [Proje planı 1](https://www.microsoft.com/microsoft-365/project/compare-microsoft-project-management-software)Için artık kullanılabilir olan Visio ve proje denemeleri ile satın alınmadan önce de çalışabilir.</span><span class="sxs-lookup"><span data-stu-id="1b221-416">Customers can also try before they buy with Visio and Project trials, available now for [Visio Plan 1 and Visio Plan 2](https://partner.microsoft.com/resources/collection/visio-availability-announcing-trial-offers#/), and [Project Plan 1](https://www.microsoft.com/microsoft-365/project/compare-microsoft-project-management-software).</span></span>


### <a name="next-steps"></a><span data-ttu-id="1b221-417">Sonraki adımlar</span><span class="sxs-lookup"><span data-stu-id="1b221-417">Next steps</span></span>

- <span data-ttu-id="1b221-418">Işlem hazırlık kaynakları galerisindeki tüm hazırlık kaynaklarını gözden geçirin: [Müşteri Self servis satın alma özelliği](https://partner.microsoft.com/resources/collection/customer-self-serve-purchase#/).</span><span class="sxs-lookup"><span data-stu-id="1b221-418">Review all readiness resources in the Operations Readiness resources gallery: [Customer self-serve purchase capability](https://partner.microsoft.com/resources/collection/customer-self-serve-purchase#/).</span></span> <span data-ttu-id="1b221-419">-Microsoft esire oturum [yeniden oluşturma ve Microsoft Visio ve güç platformuyla iş üzerinde yeniden Imagine ve](https://www.microsoft.com/microsoft-365/partners/videos/inspire-visio-power-platform)daha fazla bilgi edinin.</span><span class="sxs-lookup"><span data-stu-id="1b221-419">-Learn more about partner opportunities with Visio and Power Platform solutions in the Microsoft Inspire session [Rebuild and reimagine business with Microsoft Visio and Power Platform](https://www.microsoft.com/microsoft-365/partners/videos/inspire-visio-power-platform).</span></span>
- <span data-ttu-id="1b221-420">Daha fazla bilgi için [self servis yönetici kılavuzuna](/microsoft-365/commerce/subscriptions/manage-self-service-purchases-admins?preserve-view=true&view=o365-worldwide) bakın.</span><span class="sxs-lookup"><span data-stu-id="1b221-420">Refer to the [self-service admin guide](/microsoft-365/commerce/subscriptions/manage-self-service-purchases-admins?preserve-view=true&view=o365-worldwide) for additional information.</span></span>

________________

## <a name="new-skus-bring-the-power-of-project-cortex-and-more-to-customers"></a><a name="5"></a><span data-ttu-id="1b221-421">Yeni SKU 'Lar projenin gücünü ve daha fazlasını müşterilere getirir</span><span class="sxs-lookup"><span data-stu-id="1b221-421">New SKUs bring the power of Project Cortex and more to customers</span></span>

### <a name="categories"></a><span data-ttu-id="1b221-422">Kategoriler</span><span class="sxs-lookup"><span data-stu-id="1b221-422">Categories</span></span>

- <span data-ttu-id="1b221-423">Tarih: 2020-09-08</span><span class="sxs-lookup"><span data-stu-id="1b221-423">Date: 2020-09-08</span></span>
- <span data-ttu-id="1b221-424">Teklifler/Pazarlar</span><span class="sxs-lookup"><span data-stu-id="1b221-424">Offers/Markets</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="1b221-425">Etkilenen hedef kitle</span><span class="sxs-lookup"><span data-stu-id="1b221-425">Impacted audience</span></span>

<span data-ttu-id="1b221-426">Tüm iş ortakları bulut çözümü sağlayıcısı (CSP) programı üzerinden deneyimidir</span><span class="sxs-lookup"><span data-stu-id="1b221-426">All partners transacting through the Cloud Solution Provider (CSP) program</span></span>

### <a name="summary"></a><span data-ttu-id="1b221-427">Özet</span><span class="sxs-lookup"><span data-stu-id="1b221-427">Summary</span></span>

<span data-ttu-id="1b221-428">Müşterilerin [Proje Cortex](https://resources.techcommunity.microsoft.com/project-cortex-microsoft-365/) 'in gücünü ve [Proje](https://msturing.org/) tatminini, 1 Ekim 2020 ' den itibaren Transact tarafından kullanılabilir olmasını sağlamaya yönelik yeni SKU 'lar.</span><span class="sxs-lookup"><span data-stu-id="1b221-428">New SKUs to help customers harness the power of [Project Cortex](https://resources.techcommunity.microsoft.com/project-cortex-microsoft-365/) and [Project Turing](https://msturing.org/) will be available to transact from October 1, 2020.</span></span>

### <a name="details"></a><span data-ttu-id="1b221-429">Ayrıntılar</span><span class="sxs-lookup"><span data-stu-id="1b221-429">Details</span></span>

<span data-ttu-id="1b221-430">[Project Cortex](https://resources.techcommunity.microsoft.com/project-cortex-microsoft-365/) (akıllı içerik Hizmetleri) ve Microsoft Search (arama Için Microsoft Graph bağlayıcılar dahil) dahil olmak üzere, kullanıcıların bilgileri daha verimli bir şekilde bulmasını ve yönetmesini sağlayacak yeni SKU 'Ların 1 Ekim 2020 ' de kullanıma sunulması heyecanlıyız.</span><span class="sxs-lookup"><span data-stu-id="1b221-430">We’re excited to announce the October 1, 2020 availability of new SKUs including [Project Cortex](https://resources.techcommunity.microsoft.com/project-cortex-microsoft-365/) (Intelligent Content Services) and Microsoft Search (including Microsoft Graph Connectors for Search) that will enable users to find and manage information more efficiently.</span></span>  

#### <a name="intelligent-content-services"></a><span data-ttu-id="1b221-431">Akıllı Içerik Hizmetleri</span><span class="sxs-lookup"><span data-stu-id="1b221-431">Intelligent Content Services</span></span>
  
<span data-ttu-id="1b221-432">Akıllı Içerik Hizmetleri, içeriğin yakalanmasını, etiketlemesini ve yönetimini otomatikleştirmek için gelişmiş AI kullanır.</span><span class="sxs-lookup"><span data-stu-id="1b221-432">Intelligent Content Services uses advanced AI to automate the capture, tagging, and management of content.</span></span> <span data-ttu-id="1b221-433">Yüksek hacimli içerik işleme, işlem otomasyonu için meta verileri ayıklama, ayrıntılı güvenlik ve uyumluluk için SharePoint 'te oluşturulur.</span><span class="sxs-lookup"><span data-stu-id="1b221-433">It builds on SharePoint for high-volume content processing, extracting metadata for process automation, and fine-grained security and compliance.</span></span> <span data-ttu-id="1b221-434">Akıllı İçerik Hizmetleri bilgi işlem ve bulma deneyimlerini, bilgi ağınıza daha doğru ve kesin içerik ileterek geliştirir.</span><span class="sxs-lookup"><span data-stu-id="1b221-434">Intelligent content services improve knowledge curation and discovery experiences by pushing more accurate and precise content into your knowledge network.</span></span> <span data-ttu-id="1b221-435">Yeni akıllı Içerik Hizmetleri SKU 'Ları **1 Ekim** 'de (ve 1 Eylül fiyat listesi önizlemesinde) kullanılabilir.</span><span class="sxs-lookup"><span data-stu-id="1b221-435">New Intelligent Content Services SKUs will be available on the **October 1 price list** (and on the September 1 price list preview).</span></span> 
 
<span data-ttu-id="1b221-436">**Note:** Akıllı Içerik Hizmetleri, 1 Ekim 2020 ' den sonra yeniden markalandırılan bu ürün için yer tutucu bir addır.</span><span class="sxs-lookup"><span data-stu-id="1b221-436">**Note:** Intelligent Content Services is a placeholder name for this product, which is likely to be rebranded after October 1, 2020.</span></span>
 
<span data-ttu-id="1b221-437">**Microsoft Search için Microsoft Graph bağlayıcıları** Microsoft Graph bağlayıcılar, müşterilerin Microsoft Search sonuçlarına eklenmek üzere dış depolardaki öğelerin dizinini kurmasını sağlar.</span><span class="sxs-lookup"><span data-stu-id="1b221-437">**Microsoft Graph connectors for Microsoft Search** Microsoft Graph connectors enable customers to index items in external repositories for inclusion in Microsoft Search results.</span></span> 

<span data-ttu-id="1b221-438">1 Ekim 2020 ' den:</span><span class="sxs-lookup"><span data-stu-id="1b221-438">From October 1, 2020:</span></span> 

- <span data-ttu-id="1b221-439">Microsoft 365 E5 ve Office 365 E5, Microsoft Search için Microsoft Graph bağlayıcıları kullanarak 500 ' e kadar öğe dizinleyebilme özelliğini içerir (A5 dahil değildir).</span><span class="sxs-lookup"><span data-stu-id="1b221-439">Microsoft 365 E5 and Office 365 E5 will include the ability to index up to 500 items using Microsoft Graph connectors for Microsoft Search (not included with A5).</span></span>  
- <span data-ttu-id="1b221-440">Bir SharePoint veya OneDrive planı içeren bir pakete veya tek başına lisansa sahip herhangi bir Kullanıcı, Microsoft Search için Microsoft Graph bağlayıcılarından arama sonuçları görebilir.</span><span class="sxs-lookup"><span data-stu-id="1b221-440">Any user with a suite or standalone license that includes a SharePoint or OneDrive plan will be able to see search results from Microsoft Graph connectors for Microsoft Search.</span></span> 
- <span data-ttu-id="1b221-441">1.000.000 ek öğeye kadar dizin oluşturmak için yeni bir **ekstra Graf bağlayıcı kapasitesi SKU 'su** sunulacaktır.</span><span class="sxs-lookup"><span data-stu-id="1b221-441">A new **Extra Graph Connector Capacity SKU** will be available for indexing up to 1 million additional items.</span></span>  

#### <a name="offer-details"></a><span data-ttu-id="1b221-442">Teklif Ayrıntıları</span><span class="sxs-lookup"><span data-stu-id="1b221-442">Offer details</span></span>

   |<span data-ttu-id="1b221-443">**Teklif adı**</span><span class="sxs-lookup"><span data-stu-id="1b221-443">**Offer name**</span></span>|<span data-ttu-id="1b221-444">**Teklif Kimliği**</span><span class="sxs-lookup"><span data-stu-id="1b221-444">**Offer ID**</span></span>|<span data-ttu-id="1b221-445">**Malzeme KIMLIĞI**</span><span class="sxs-lookup"><span data-stu-id="1b221-445">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="1b221-446">Akıllı Içerik Hizmetleri</span><span class="sxs-lookup"><span data-stu-id="1b221-446">Intelligent Content Services</span></span>|<span data-ttu-id="1b221-447">2e969027-6eca-44a3-88fb-e7923e2c147f</span><span class="sxs-lookup"><span data-stu-id="1b221-447">2e969027-6eca-44a3-88fb-e7923e2c147f</span></span>|<span data-ttu-id="1b221-448">5YI-00004</span><span class="sxs-lookup"><span data-stu-id="1b221-448">5YI-00004</span></span>|
   |<span data-ttu-id="1b221-449">Akıllı Içerik Hizmetleri (kar amacı gütmeyen personel fiyatlandırması)</span><span class="sxs-lookup"><span data-stu-id="1b221-449">Intelligent Content Services (Nonprofit Staff Pricing)</span></span>|<span data-ttu-id="1b221-450">48db24e2-0aac-47bd-bd74-40bde9ff7748</span><span class="sxs-lookup"><span data-stu-id="1b221-450">48db24e2-0aac-47bd-bd74-40bde9ff7748</span></span>|<span data-ttu-id="1b221-451">5YI-00005</span><span class="sxs-lookup"><span data-stu-id="1b221-451">5YI-00005</span></span>|
   |<span data-ttu-id="1b221-452">Fakülte için akıllı Içerik Hizmetleri</span><span class="sxs-lookup"><span data-stu-id="1b221-452">Intelligent Content Services for faculty</span></span>|<span data-ttu-id="1b221-453">4a8f9036-791e-4ce4-a788-6c5af859fd82</span><span class="sxs-lookup"><span data-stu-id="1b221-453">4a8f9036-791e-4ce4-a788-6c5af859fd82</span></span>|<span data-ttu-id="1b221-454">5Z1-00005</span><span class="sxs-lookup"><span data-stu-id="1b221-454">5Z1-00005</span></span>|
   |<span data-ttu-id="1b221-455">Ekstra Graf bağlayıcı kapasitesi</span><span class="sxs-lookup"><span data-stu-id="1b221-455">Extra Graph Connector Capacity</span></span>|<span data-ttu-id="1b221-456">9c8b008f-d84f-46cd-A588-fea84947161d</span><span class="sxs-lookup"><span data-stu-id="1b221-456">9c8b008f-d84f-46cd-a588-fea84947161d</span></span>|<span data-ttu-id="1b221-457">1LA-00002</span><span class="sxs-lookup"><span data-stu-id="1b221-457">1LA-00002</span></span>|
   |<span data-ttu-id="1b221-458">Fakülteler için ekstra Graf bağlayıcı kapasitesi</span><span class="sxs-lookup"><span data-stu-id="1b221-458">Extra Graph Connector Capacity for faculty</span></span>|<span data-ttu-id="1b221-459">0e0eb210-86e7-4038-9905-4fd5bf71c4bd</span><span class="sxs-lookup"><span data-stu-id="1b221-459">0e0eb210-86e7-4038-9905-4fd5bf71c4bd</span></span>|<span data-ttu-id="1b221-460">1TL-00003</span><span class="sxs-lookup"><span data-stu-id="1b221-460">1TL-00003</span></span>|

### <a name="next-steps"></a><span data-ttu-id="1b221-461">Sonraki adımlar</span><span class="sxs-lookup"><span data-stu-id="1b221-461">Next steps</span></span>

- <span data-ttu-id="1b221-462">Bu konunun kaynaklarını gözden geçirin ve kuruluşunuzdaki uygun hissedarlarla paylaşabilirsiniz.</span><span class="sxs-lookup"><span data-stu-id="1b221-462">Review the resources for this topic and share them with the appropriate stakeholders in your organization.</span></span>
- <span data-ttu-id="1b221-463">Bu tekliflerle ilgili sorularınız varsa ilgili Yammer topluluklarınızı kontrol edin.</span><span class="sxs-lookup"><span data-stu-id="1b221-463">If you have any questions about these offers, check your relevant Yammer communities.</span></span>

________________

## <a name="enhanced-incentives-support-experience-and-ticket-creation-process"></a><a name="4"></a><span data-ttu-id="1b221-464">Geliştirilmiş teşvikleri destek deneyimi ve bilet oluşturma işlemi</span><span class="sxs-lookup"><span data-stu-id="1b221-464">Enhanced Incentives support experience and ticket creation process</span></span>

### <a name="categories"></a><span data-ttu-id="1b221-465">Kategoriler</span><span class="sxs-lookup"><span data-stu-id="1b221-465">Categories</span></span>

- <span data-ttu-id="1b221-466">Tarih: 2020-09-02</span><span class="sxs-lookup"><span data-stu-id="1b221-466">Date: 2020-09-02</span></span>
- <span data-ttu-id="1b221-467">Özellikler</span><span class="sxs-lookup"><span data-stu-id="1b221-467">Capabilities</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="1b221-468">Etkilenen hedef kitle</span><span class="sxs-lookup"><span data-stu-id="1b221-468">Impacted audience</span></span>

<span data-ttu-id="1b221-469">Tüm iş ortakları</span><span class="sxs-lookup"><span data-stu-id="1b221-469">All partners</span></span>

### <a name="summary"></a><span data-ttu-id="1b221-470">Özet</span><span class="sxs-lookup"><span data-stu-id="1b221-470">Summary</span></span>

<span data-ttu-id="1b221-471">Iş ortağı teşvikleri destek deneyimi, geliştirilmiş kendi kendine yardım içeriği keşfedilebilirlik ve kolaylaştırılmış bir çevrimiçi bilet gönderim süreciyle geliştirilmiştir.</span><span class="sxs-lookup"><span data-stu-id="1b221-471">The Partner Incentives support experience has been enhanced with improved self-help content discoverability and a streamlined online ticket submission process.</span></span>

### <a name="details"></a><span data-ttu-id="1b221-472">Ayrıntılar</span><span class="sxs-lookup"><span data-stu-id="1b221-472">Details</span></span>

<span data-ttu-id="1b221-473">Iş ortağı teşvikleri için geliştirmeler eklenmiştir ve bu işlem, destek süreci sırasında geri ve ileri veri toplamayı azaltan kolaylaştırılmış bir bilet gönderim sürecinden daha iyi bir şekilde yardımcı olur.</span><span class="sxs-lookup"><span data-stu-id="1b221-473">Enhancements have been added for Partner Incentives to improve your overall support experience through better self-help content discoverability and a streamlined ticket submission process that reduces back-and-forth data collection during the support process.</span></span>

#### <a name="new-capabilities"></a><span data-ttu-id="1b221-474">Yeni özellikler</span><span class="sxs-lookup"><span data-stu-id="1b221-474">New capabilities</span></span>

- <span data-ttu-id="1b221-475">Yeni arama tabanlı kendi kendine yardım deneyimine iş ortağı [Merkezi](https://aka.ms/IncentivesSupport) 'Nden ve iş ortağı olmayan orta hesaplara yönelik [Microsoft iş ortağı ağı](https://partner.microsoft.com/support/?stage=1) erişilebilir.</span><span class="sxs-lookup"><span data-stu-id="1b221-475">New search-based self-help experience is accessible within [Partner Center](https://aka.ms/IncentivesSupport) and on [Microsoft Partner Network](https://partner.microsoft.com/support/?stage=1) for non-Partner Center accounts.</span></span> <span data-ttu-id="1b221-476">Yeni deneyim, yeni sorun giderme adımlarını, SSS 'leri ve ilgili Self-yardım makalelerini ve Microsoft İş Ortağı Ağı destek sayfasını içeren bağlantıları içerir.</span><span class="sxs-lookup"><span data-stu-id="1b221-476">The new experience includes new troubleshooting steps, FAQs, and links to relevant self-help articles as well as on the Microsoft Partner Network Support page.</span></span>
- <span data-ttu-id="1b221-477">Doğrudan Iş Ortağı Merkezi 'nde yeni bir destek isteği başlatın.</span><span class="sxs-lookup"><span data-stu-id="1b221-477">Initiate a new support request directly in Partner Center.</span></span> <span data-ttu-id="1b221-478">Uygun konuya özgü yardımı görüntüledikten sonra, hala yardıma ihtiyacınız varsa doğrudan Iş Ortağı Merkezi 'nden bir bilet oluşturabilirsiniz.</span><span class="sxs-lookup"><span data-stu-id="1b221-478">After viewing the available topic-specific help, if you still need assistance, you can only create a ticket directly from Partner Center.</span></span>
- <span data-ttu-id="1b221-479">Yeni sorun kapsamı soruları, her kendi kendine yardım konusu için kullanılabilir.</span><span class="sxs-lookup"><span data-stu-id="1b221-479">New problem-scoping questions are available for every self-help topic.</span></span> <span data-ttu-id="1b221-480">Bu soruların tamamlanması, en önemli ayrıntıların birçoğunu içeren aracıyı sağlayarak destek biletinin başlangıcında geri ve geriye doğru bir ölçüde azaltır.</span><span class="sxs-lookup"><span data-stu-id="1b221-480">Completing these questions reduces much of the back-and-forth at the beginning of the support ticket by providing the agent with many of the important details up front.</span></span>


### <a name="next-steps"></a><span data-ttu-id="1b221-481">Sonraki adımlar</span><span class="sxs-lookup"><span data-stu-id="1b221-481">Next steps</span></span>

- <span data-ttu-id="1b221-482">Bu bilgileri kuruluşunuzdaki diğer kullanıcılarla paylaşabilirsiniz.</span><span class="sxs-lookup"><span data-stu-id="1b221-482">Share this information with others in your organization.</span></span> 
- <span data-ttu-id="1b221-483">Tüm teşvikleri destek gereksinimleriniz için [Iş Ortağı Merkezi](https://aka.ms/IncentivesSupport) veya [Microsoft iş ortağı ağı](https://partner.microsoft.com/support/?stage=1) ile yeni destek deneyimini kullanın.</span><span class="sxs-lookup"><span data-stu-id="1b221-483">Use the new support experience via [Partner Center](https://aka.ms/IncentivesSupport) or on [Microsoft Partner Network](https://partner.microsoft.com/support/?stage=1) for all your Incentives support requirements.</span></span> 

<span data-ttu-id="1b221-484">**Note:** Bu işlev devre dışı olduğundan, destek istekleri doğrudan e-posta aracılığıyla kabul edilmez.</span><span class="sxs-lookup"><span data-stu-id="1b221-484">**Note:** Support requests will not be accepted through direct email, as this function is retired.</span></span>

________________

## <a name="upcoming-new-microsoft-dynamics-365-offers"></a><a name="3"></a><span data-ttu-id="1b221-485">Yaklaşan yeni Microsoft Dynamics 365 teklifleri</span><span class="sxs-lookup"><span data-stu-id="1b221-485">Upcoming new Microsoft Dynamics 365 offers</span></span>

### <a name="categories"></a><span data-ttu-id="1b221-486">Kategoriler</span><span class="sxs-lookup"><span data-stu-id="1b221-486">Categories</span></span>

- <span data-ttu-id="1b221-487">Tarih: 2020-09-01</span><span class="sxs-lookup"><span data-stu-id="1b221-487">Date: 2020-09-01</span></span>
- <span data-ttu-id="1b221-488">Teklifler/Pazarlar</span><span class="sxs-lookup"><span data-stu-id="1b221-488">Offers/Markets</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="1b221-489">Etkilenen hedef kitle</span><span class="sxs-lookup"><span data-stu-id="1b221-489">Impacted audience</span></span>

<span data-ttu-id="1b221-490">İş ortakları deneyimidir Microsoft Dynamics 365</span><span class="sxs-lookup"><span data-stu-id="1b221-490">Partners transacting Microsoft Dynamics 365</span></span>

### <a name="summary"></a><span data-ttu-id="1b221-491">Özet</span><span class="sxs-lookup"><span data-stu-id="1b221-491">Summary</span></span>

<span data-ttu-id="1b221-492">Microsoft Dynamics 365 müşterileri için yaklaşan teklifler, Microsoft Project Işlemlerinin ve Iş Merkezi için ek ortamların bir sürümünü içerir.</span><span class="sxs-lookup"><span data-stu-id="1b221-492">Upcoming offers for Microsoft Dynamics 365 customers include the release of Microsoft Project Operations, and additional environments for Business Central.</span></span>

### <a name="details"></a><span data-ttu-id="1b221-493">Ayrıntılar</span><span class="sxs-lookup"><span data-stu-id="1b221-493">Details</span></span>

<span data-ttu-id="1b221-494">Aşağıdaki yeni teklifler 1 Ekim 2020 ' de kullanıma sunulacaktır.</span><span class="sxs-lookup"><span data-stu-id="1b221-494">The following new offers will be available on October 1, 2020.</span></span>

#### <a name="project-operations"></a><span data-ttu-id="1b221-495">Project Operations</span><span class="sxs-lookup"><span data-stu-id="1b221-495">Project Operations</span></span>

<span data-ttu-id="1b221-496">Microsoft, 1 Ekim 2020 ' de, Dynamics 365 proje Işlemleri tekliflerini yayımlayacaktır ve bulut çözümü sağlayıcısı (CSP) programı için Dynamics 365 proje hizmet Otomasyonu 'nu (PSA) kullanıma sunacaktır.</span><span class="sxs-lookup"><span data-stu-id="1b221-496">On October 1, 2020, Microsoft will release Dynamics 365 Project Operations offers and remove Dynamics 365 Project Service Automation (PSA) for the Cloud Solution Provider (CSP) program.</span></span> <span data-ttu-id="1b221-497">Yeni müşteriler Dynamics 365 proje Işlemlerini satın almalıdır.</span><span class="sxs-lookup"><span data-stu-id="1b221-497">New customers must purchase Dynamics 365 Project Operations.</span></span> 

<span data-ttu-id="1b221-498">PSA ile mevcut Dynamics 365 müşterileri için:</span><span class="sxs-lookup"><span data-stu-id="1b221-498">For existing Dynamics 365 customers with PSA:</span></span>

- <span data-ttu-id="1b221-499">1 Ekim 2020 ' e kadar veya en son sözleşme veya yenilemesinin sonuna kadar, hangisi önce gerçekleşene kadar Dynamics 365 PSA kullanmaya devam edin.</span><span class="sxs-lookup"><span data-stu-id="1b221-499">Continue to use Dynamics 365 PSA until October 1, 2020, or until the end of their most recent contract or renewal, whichever occurs first.</span></span>
- <span data-ttu-id="1b221-500">Dynamics 365 PSA, 1 2021 Ekim tarihine kadar bir yıl boyunca autorenew, sözleşmelerin 1 Ekim 2022 ' e kadar devam etmesine olanak sağlar.</span><span class="sxs-lookup"><span data-stu-id="1b221-500">Dynamics 365 PSA will autorenew for one year until October 1, 2021 in CSP, allowing contracts to continue until October 1, 2022.</span></span>
- <span data-ttu-id="1b221-501">Dynamics 365 PSA lisansları, geçerli lisanslarının bir parçası olarak 31 Aralık 2020 tarihine kadar proje Işlemlerini otomatik olarak alır.</span><span class="sxs-lookup"><span data-stu-id="1b221-501">Dynamics 365 PSA licenses will automatically receive Project Operations as part of their current licenses by December 31, 2020.</span></span>
- <span data-ttu-id="1b221-502">Dynamics 365 PSA sözleşmelerinin sonunda müşterilerin, sıfır Kullanıcı minimum PSA geçişi SKU 'SU olacak proje Işlemlerine geçmesi gerekir.</span><span class="sxs-lookup"><span data-stu-id="1b221-502">At the end of Dynamics 365 PSA contracts, customers need to transition to Project Operations, which will have a zero user minimum PSA transition SKU.</span></span>

<span data-ttu-id="1b221-503">Teklif KIMLIĞI ayrıntıları için [DYNAMICS CSP Offers-October 2020 Excel belgesinde](https://partner.microsoft.com/resources/detail/microsoft-dynamics-365-new-ids-offers-csp-october-2020-xls) proje işlemleri sekmesini gözden geçirin.</span><span class="sxs-lookup"><span data-stu-id="1b221-503">Review the Project Operations tab in the [Dynamics CSP Offers-October 2020 Excel document](https://partner.microsoft.com/resources/detail/microsoft-dynamics-365-new-ids-offers-csp-october-2020-xls) for the offer ID details.</span></span>

#### <a name="additional-resources"></a><span data-ttu-id="1b221-504">Ek kaynaklar</span><span class="sxs-lookup"><span data-stu-id="1b221-504">Additional resources</span></span>

- <span data-ttu-id="1b221-505">PSA için [geçiş kaynakları](https://partner.microsoft.com/asset/collection/psa-transition-resources#/)</span><span class="sxs-lookup"><span data-stu-id="1b221-505">[Transition resources](https://partner.microsoft.com/asset/collection/psa-transition-resources#/) for PSA</span></span>
- <span data-ttu-id="1b221-506">[Microsoft Dynamics 365 Project Service Automation](https://cloudblogs.microsoft.com/dynamics365/bdm/2020/02/20/introducing-microsoft-dynamics-365-project-operations/) bloguna giriş</span><span class="sxs-lookup"><span data-stu-id="1b221-506">[Introducing Microsoft Dynamics 365 Project Service Automation](https://cloudblogs.microsoft.com/dynamics365/bdm/2020/02/20/introducing-microsoft-dynamics-365-project-operations/) blog</span></span>
- <span data-ttu-id="1b221-507">[Microsoft Dynamics 365 Project Service Automation eğitim malzemesine neler geliyor?](https://assetsprod.microsoft.com/mpn/what-is-coming-in-d365-project-service-automation-dyn767pal.pdf)</span><span class="sxs-lookup"><span data-stu-id="1b221-507">[What is coming in Microsoft Dynamics 365 Project Service Automation](https://assetsprod.microsoft.com/mpn/what-is-coming-in-d365-project-service-automation-dyn767pal.pdf) training material</span></span>

#### <a name="expansion-of-business-central-offers-into-additional-countries"></a><span data-ttu-id="1b221-508">Iş Merkezi tekliflerinin ek ülkelere genişletilmesi</span><span class="sxs-lookup"><span data-stu-id="1b221-508">Expansion of Business Central offers into additional countries</span></span>

<span data-ttu-id="1b221-509">Microsoft, 1 Ekim 2020 ' de, Iş Merkezi bulut tekliflerini Brezilya, Irlanda, Litvanya, Faroe Adaları ve Grönland 'da genişletiyor.</span><span class="sxs-lookup"><span data-stu-id="1b221-509">On October 1, 2020, Microsoft is expanding Business Central Cloud offers into Brazil, Ireland, Lithuania, the Faroe Islands, and Greenland.</span></span>

#### <a name="business-central-additional-environments"></a><span data-ttu-id="1b221-510">İş Merkezi ek ortamları</span><span class="sxs-lookup"><span data-stu-id="1b221-510">Business Central additional environments</span></span>

<span data-ttu-id="1b221-511">1 Ekim 2020 ' de, müşterilerin ekstra ortamlar eklemesine olanak tanımak için Iş Merkezi bulut tekliflerine yönelik yeni eklenti teklifleri sunulacaktır.</span><span class="sxs-lookup"><span data-stu-id="1b221-511">On October 1, 2020, new add-on offers for Business Central Cloud offers will be available to enable customers to add extra environments.</span></span> 

<span data-ttu-id="1b221-512">Teklif KIMLIĞI ayrıntıları için [DYNAMICS CSP Offers-October 2020 Excel belgesinde](https://partner.microsoft.com/resources/detail/microsoft-dynamics-365-new-ids-offers-csp-october-2020-xls) **ek ortamlar** sekmesini gözden geçirin.</span><span class="sxs-lookup"><span data-stu-id="1b221-512">Review the **Additional Environments** tab in the [Dynamics CSP Offers-October 2020 Excel document](https://partner.microsoft.com/resources/detail/microsoft-dynamics-365-new-ids-offers-csp-october-2020-xls) for the offer ID details.</span></span>

### <a name="next-steps"></a><span data-ttu-id="1b221-513">Sonraki adımlar</span><span class="sxs-lookup"><span data-stu-id="1b221-513">Next steps</span></span>

<span data-ttu-id="1b221-514">Bu güncelleştirmeyi kuruluşunuzdaki ilgili kişilerle paylaşabilirsiniz.</span><span class="sxs-lookup"><span data-stu-id="1b221-514">Share this update with the relevant contacts in your organization.</span></span>

________________

## <a name="office-365-calling-plan-will-be-available-in-new-markets-on-october-1-2020"></a><a name="2"></a><span data-ttu-id="1b221-515">Office 365 çağırma planı, 1 Ekim 2020 ' de yeni pazarlarda kullanıma sunulacaktır</span><span class="sxs-lookup"><span data-stu-id="1b221-515">Office 365 Calling Plan will be available in new markets on October 1, 2020</span></span>

### <a name="categories"></a><span data-ttu-id="1b221-516">Kategoriler</span><span class="sxs-lookup"><span data-stu-id="1b221-516">Categories</span></span>

- <span data-ttu-id="1b221-517">Tarih: 2020-09-01</span><span class="sxs-lookup"><span data-stu-id="1b221-517">Date: 2020-09-01</span></span>
- <span data-ttu-id="1b221-518">Teklifler/Pazarlar</span><span class="sxs-lookup"><span data-stu-id="1b221-518">Offers/Markets</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="1b221-519">Etkilenen hedef kitle</span><span class="sxs-lookup"><span data-stu-id="1b221-519">Impacted audience</span></span>

<span data-ttu-id="1b221-520">Doğrudan sağlayıcılar, dolaylı sağlayıcılar ve dolaylı satıcılar dahil olmak üzere bulut çözümü sağlayıcısı (CSP) iş ortakları</span><span class="sxs-lookup"><span data-stu-id="1b221-520">Cloud Solution Provider (CSP) partners, including direct providers, indirect providers, and indirect resellers</span></span>

### <a name="summary"></a><span data-ttu-id="1b221-521">Özet</span><span class="sxs-lookup"><span data-stu-id="1b221-521">Summary</span></span>

<span data-ttu-id="1b221-522">Microsoft, çağrı planının 1 Ekim 2020: Avusturya, Danimarka, Italya, Portekiz, Isveç ve Isviçre 'de şu yeni pazarlarda kullanılabilir olacağını duyurmak için heyecanlıdır.</span><span class="sxs-lookup"><span data-stu-id="1b221-522">Microsoft is excited to announce that Calling Plan will be available in the following new markets on October 1, 2020: Austria, Denmark, Italy, Portugal, Sweden, and Switzerland.</span></span> 

### <a name="details"></a><span data-ttu-id="1b221-523">Ayrıntılar</span><span class="sxs-lookup"><span data-stu-id="1b221-523">Details</span></span>

<span data-ttu-id="1b221-524">Microsoft 365 çağrı planı 1 Ekim 2020 ' de aşağıdaki yeni pazarlarda kullanılabilir olacaktır: Avusturya, Danimarka, Italya, Portekiz, Isveç ve Isviçre.</span><span class="sxs-lookup"><span data-stu-id="1b221-524">Microsoft 365 Calling Plan will be available in the following new markets on October 1, 2020: Austria, Denmark, Italy, Portugal, Sweden, and Switzerland.</span></span> <span data-ttu-id="1b221-525">Yeni coğrafi kullanılabilirlik, Kurumsal Anlaşma (EA) veya Kurumsal Anlaşma aboneliği (EAS) yoluyla ticari, dünya çapındaki kamu sektörü, kar amacı gütmeyen ve kamu topluluğu bulutu, eğitim çözümleri için kayıt (EES), Web Direct ve CSP aracılığıyla başlatılır.</span><span class="sxs-lookup"><span data-stu-id="1b221-525">The new geo availability will launch in Commercial, Worldwide Public Sector, Nonprofit, and Government Community Cloud via Enterprise Agreement (EA) or Enterprise Agreement Subscription (EAS), Enrollment for Education Solutions (EES), Web Direct, and CSP.</span></span> 

<span data-ttu-id="1b221-526">Tüm çağrı planı özellikleri, Microsoft 'un bir ayda 120, 240 ve 1.200 dakika (p/u/m) yurtiçi planlarında ve Uluslararası plan olan 1.200 yurtiçi minutes p/u/m ve 600 Uluslararası dakikada p/u/m dahil olmak üzere, Microsoft 'un yurtiçi ve uluslararası arama planlarında kullanılabilir.</span><span class="sxs-lookup"><span data-stu-id="1b221-526">All Calling Plan features will be available for Microsoft’s Domestic and International Calling Plans, including the 120, 240, and 1,200 minutes per user per month (p/u/m) Domestic plans, and the International Plan with 1,200 domestic minutes p/u/m and 600 international minutes p/u/m.</span></span> 

<span data-ttu-id="1b221-527">[Modern Iş lisanslama hakkında SSS](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements)bölümündeki arama planı bölümünde planları, aşırı kullanımı ve iletişim kredilerini çağırmaya yönelik ek ayrıntılar bulabilirsiniz.</span><span class="sxs-lookup"><span data-stu-id="1b221-527">Find additional details for Calling Plans, excessive usage, and communications credits in the Calling Plan section of the [Modern Work Licensing FAQ](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements).</span></span>

<span data-ttu-id="1b221-528">Arama planı, şu anda Belçika, Kanada, Fransa, Almanya, Irlanda, Hollanda, Porto Riko (yalnızca EA ve Evet ile sınırlı kanal kullanılabilirliği), Ispanya, Birleşik Krallık ve Birleşik Devletler (Avustralya ve Japonya 'da üçüncü taraf arama planı kullanılabilirliği) ile kullanılabilir.</span><span class="sxs-lookup"><span data-stu-id="1b221-528">Calling Plan is currently available in Belgium, Canada, France, Germany, Ireland, Netherlands, Puerto Rico (channel availability limited to EA and EES only), Spain, the United Kingdom, and the United States (third-party Calling Plan availability in Australia and Japan).</span></span>

#### <a name="offer-details"></a><span data-ttu-id="1b221-529">Teklif Ayrıntıları</span><span class="sxs-lookup"><span data-stu-id="1b221-529">Offer details</span></span>

   |<span data-ttu-id="1b221-530">**Teklif adı**</span><span class="sxs-lookup"><span data-stu-id="1b221-530">**Offer name**</span></span>|<span data-ttu-id="1b221-531">**Teklif Kimliği**</span><span class="sxs-lookup"><span data-stu-id="1b221-531">**Offer ID**</span></span>|<span data-ttu-id="1b221-532">**Malzeme KIMLIĞI**</span><span class="sxs-lookup"><span data-stu-id="1b221-532">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="1b221-533">Microsoft 365 yurtiçi arama planı</span><span class="sxs-lookup"><span data-stu-id="1b221-533">Microsoft 365 Domestic Calling Plan</span></span>|<span data-ttu-id="1b221-534">52b01454-aa44-4e03-8049-c4d57496a430</span><span class="sxs-lookup"><span data-stu-id="1b221-534">52b01454-aa44-4e03-8049-c4d57496a430</span></span>|<span data-ttu-id="1b221-535">4ıD-00002</span><span class="sxs-lookup"><span data-stu-id="1b221-535">4ID-00002</span></span>|
   |<span data-ttu-id="1b221-536">Microsoft 365 yurtiçi arama planı</span><span class="sxs-lookup"><span data-stu-id="1b221-536">Microsoft 365 Domestic Calling Plan</span></span>|<span data-ttu-id="1b221-537">0f598efe-F330-4d79-b79f-c9480bb7ce3e</span><span class="sxs-lookup"><span data-stu-id="1b221-537">0f598efe-f330-4d79-b79f-c9480bb7ce3e</span></span>|<span data-ttu-id="1b221-538">AAA-13706</span><span class="sxs-lookup"><span data-stu-id="1b221-538">AAA-13706</span></span>|
   |<span data-ttu-id="1b221-539">Microsoft 365 yurtiçi arama planı (kamu fiyatlandırması)</span><span class="sxs-lookup"><span data-stu-id="1b221-539">Microsoft 365 Domestic Calling Plan (Government Pricing)</span></span>|<span data-ttu-id="1b221-540">96b96fd8-b77d-41A4-ae5d-0a6652f454b7</span><span class="sxs-lookup"><span data-stu-id="1b221-540">96b96fd8-b77d-41a4-ae5d-0a6652f454b7</span></span>|<span data-ttu-id="1b221-541">AAA-13707</span><span class="sxs-lookup"><span data-stu-id="1b221-541">AAA-13707</span></span>|
   |<span data-ttu-id="1b221-542">Öğrenciler için yurtiçi çağrı planını Microsoft 365</span><span class="sxs-lookup"><span data-stu-id="1b221-542">Microsoft 365 Domestic Calling Plan for students</span></span>|<span data-ttu-id="1b221-543">da2034e1-c147-4aae-afab-9c15acf16ea5</span><span class="sxs-lookup"><span data-stu-id="1b221-543">da2034e1-c147-4aae-afab-9c15acf16ea5</span></span>|<span data-ttu-id="1b221-544">AAA-22335</span><span class="sxs-lookup"><span data-stu-id="1b221-544">AAA-22335</span></span>|
   |<span data-ttu-id="1b221-545">Fakülteler için yurtiçi çağrı planını Microsoft 365</span><span class="sxs-lookup"><span data-stu-id="1b221-545">Microsoft 365 Domestic Calling Plan for faculty</span></span>|<span data-ttu-id="1b221-546">5e8853ed-611c-4f9c-af21-540ba351a636</span><span class="sxs-lookup"><span data-stu-id="1b221-546">5e8853ed-611c-4f9c-af21-540ba351a636</span></span>|<span data-ttu-id="1b221-547">AAA-22334</span><span class="sxs-lookup"><span data-stu-id="1b221-547">AAA-22334</span></span>|
   |<span data-ttu-id="1b221-548">GCC için yurtiçi çağrı planını Microsoft 365</span><span class="sxs-lookup"><span data-stu-id="1b221-548">Microsoft 365 Domestic Calling Plan for GCC</span></span>|<span data-ttu-id="1b221-549">7099743e-F474-48BE-97bc-d4fb22f059bf</span><span class="sxs-lookup"><span data-stu-id="1b221-549">7099743e-f474-48be-97bc-d4fb22f059bf</span></span>|<span data-ttu-id="1b221-550">AAD-25690</span><span class="sxs-lookup"><span data-stu-id="1b221-550">AAD-25690</span></span>|
   |<span data-ttu-id="1b221-551">Microsoft 365 yurtiçi ve uluslararası arama planı</span><span class="sxs-lookup"><span data-stu-id="1b221-551">Microsoft 365 Domestic and International Calling Plan</span></span>|<span data-ttu-id="1b221-552">ded34535-507f-4246-8370-f9180318c537</span><span class="sxs-lookup"><span data-stu-id="1b221-552">ded34535-507f-4246-8370-f9180318c537</span></span>|<span data-ttu-id="1b221-553">AAA-13708</span><span class="sxs-lookup"><span data-stu-id="1b221-553">AAA-13708</span></span>|
   |<span data-ttu-id="1b221-554">Microsoft 365 yurtiçi ve uluslararası arama planı (kamu fiyatlandırması)</span><span class="sxs-lookup"><span data-stu-id="1b221-554">Microsoft 365 Domestic and International Calling Plan (Government Pricing)</span></span>|<span data-ttu-id="1b221-555">d97b23b4-627c-41db-8f55-ce342b0db656</span><span class="sxs-lookup"><span data-stu-id="1b221-555">d97b23b4-627c-41db-8f55-ce342b0db656</span></span>|<span data-ttu-id="1b221-556">AAA-13709</span><span class="sxs-lookup"><span data-stu-id="1b221-556">AAA-13709</span></span>|
   |<span data-ttu-id="1b221-557">Öğrenciler için yurtiçi ve uluslararası çağrı planını Microsoft 365</span><span class="sxs-lookup"><span data-stu-id="1b221-557">Microsoft 365 Domestic and International Calling Plan for students</span></span>|<span data-ttu-id="1b221-558">64ed3fb4-9f46-4e8a-b287-7a3662245c37</span><span class="sxs-lookup"><span data-stu-id="1b221-558">64ed3fb4-9f46-4e8a-b287-7a3662245c37</span></span>|<span data-ttu-id="1b221-559">AAA-22337</span><span class="sxs-lookup"><span data-stu-id="1b221-559">AAA-22337</span></span>|
   |<span data-ttu-id="1b221-560">Fakülteler için yurtiçi ve uluslararası çağrı planını Microsoft 365</span><span class="sxs-lookup"><span data-stu-id="1b221-560">Microsoft 365 Domestic and International Calling Plan for faculty</span></span>|<span data-ttu-id="1b221-561">492b8a14-381c-4536-bf63-bd5785c14734</span><span class="sxs-lookup"><span data-stu-id="1b221-561">492b8a14-381c-4536-bf63-bd5785c14734</span></span>|<span data-ttu-id="1b221-562">AAA-22336</span><span class="sxs-lookup"><span data-stu-id="1b221-562">AAA-22336</span></span>|
   |<span data-ttu-id="1b221-563">GCC için yurtiçi ve uluslararası çağrı planını Microsoft 365</span><span class="sxs-lookup"><span data-stu-id="1b221-563">Microsoft 365 Domestic and International Calling Plan for GCC</span></span>|<span data-ttu-id="1b221-564">0cf5df85-ecf5-43f5-93b0-04a950e906a3</span><span class="sxs-lookup"><span data-stu-id="1b221-564">0cf5df85-ecf5-43f5-93b0-04a950e906a3</span></span>|<span data-ttu-id="1b221-565">AAD-25680</span><span class="sxs-lookup"><span data-stu-id="1b221-565">AAD-25680</span></span>|
   |<span data-ttu-id="1b221-566">Microsoft 365 yurtiçi arama planı (120 dk)</span><span class="sxs-lookup"><span data-stu-id="1b221-566">Microsoft 365 Domestic Calling Plan (120 min)</span></span>|<span data-ttu-id="1b221-567">40d28d55-0006-4bb0-8f41-37ac05df5dc7</span><span class="sxs-lookup"><span data-stu-id="1b221-567">40d28d55-0006-4bb0-8f41-37ac05df5dc7</span></span>|<span data-ttu-id="1b221-568">AAD-11639</span><span class="sxs-lookup"><span data-stu-id="1b221-568">AAD-11639</span></span>|
   |<span data-ttu-id="1b221-569">Öğrenciler için Microsoft 365 yurtiçi çağrı planı (120 dak)</span><span class="sxs-lookup"><span data-stu-id="1b221-569">Microsoft 365 Domestic Calling Plan (120 min) for students</span></span>|<span data-ttu-id="1b221-570">353d7f89-2e6f-4DEB-9145-80f281a782ab</span><span class="sxs-lookup"><span data-stu-id="1b221-570">353d7f89-2e6f-4deb-9145-80f281a782ab</span></span>|<span data-ttu-id="1b221-571">AAD-11641</span><span class="sxs-lookup"><span data-stu-id="1b221-571">AAD-11641</span></span>|
   |<span data-ttu-id="1b221-572">Fakülteler için yurtiçi çağrı planını Microsoft 365 (120 dak)</span><span class="sxs-lookup"><span data-stu-id="1b221-572">Microsoft 365 Domestic Calling Plan (120 min) for faculty</span></span>|<span data-ttu-id="1b221-573">80fc6c74-cc94-478D-97b0-8455593a5987</span><span class="sxs-lookup"><span data-stu-id="1b221-573">80fc6c74-cc94-478d-97b0-8455593a5987</span></span>|<span data-ttu-id="1b221-574">AAD-11640</span><span class="sxs-lookup"><span data-stu-id="1b221-574">AAD-11640</span></span>|

### <a name="next-steps"></a><span data-ttu-id="1b221-575">Sonraki adımlar</span><span class="sxs-lookup"><span data-stu-id="1b221-575">Next steps</span></span>

<span data-ttu-id="1b221-576">Bu konuyla ilgili kaynakları gözden geçirin ve bu bilgileri kuruluşunuzdaki uygun hissedarlarla paylaşabilirsiniz.</span><span class="sxs-lookup"><span data-stu-id="1b221-576">Review the resources about this topic, and share this information with the appropriate stakeholders in your organization.</span></span>

________________

## <a name="microsoft-defender-advanced-threat-protection-atp-for-servers-for-education-is-now-available"></a><a name="1"></a><span data-ttu-id="1b221-577">Eğitim için sunucular için Microsoft Defender Gelişmiş tehdit koruması (ATP) artık kullanıma sunuldu</span><span class="sxs-lookup"><span data-stu-id="1b221-577">Microsoft Defender Advanced Threat Protection (ATP) for Servers for Education is now available</span></span>

### <a name="categories"></a><span data-ttu-id="1b221-578">Kategoriler</span><span class="sxs-lookup"><span data-stu-id="1b221-578">Categories</span></span>

- <span data-ttu-id="1b221-579">Tarih: 2020-09-01</span><span class="sxs-lookup"><span data-stu-id="1b221-579">Date: 2020-09-01</span></span>
- <span data-ttu-id="1b221-580">Teklifler/Pazarlar</span><span class="sxs-lookup"><span data-stu-id="1b221-580">Offers/Markets</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="1b221-581">Etkilenen hedef kitle</span><span class="sxs-lookup"><span data-stu-id="1b221-581">Impacted audience</span></span>

<span data-ttu-id="1b221-582">CSP programına katılan tüm iş ortakları</span><span class="sxs-lookup"><span data-stu-id="1b221-582">All partners participating in the CSP program</span></span> 

### <a name="details"></a><span data-ttu-id="1b221-583">Ayrıntılar</span><span class="sxs-lookup"><span data-stu-id="1b221-583">Details</span></span>

<span data-ttu-id="1b221-584">Eğitim için sunucular için Microsoft Defender Gelişmiş tehdit koruması (ATP), bulut çözümü sağlayıcısı (CSP) programında 1 Eylül 2020 itibariyle kullanıma sunulmuştur.</span><span class="sxs-lookup"><span data-stu-id="1b221-584">Microsoft Defender Advanced Threat Protection (ATP) for Servers for Education is now available, as of September 1, 2020 in the Cloud Solution Provider (CSP) program.</span></span>  
<span data-ttu-id="1b221-585">Ürün teklifi ayrıntıları:</span><span class="sxs-lookup"><span data-stu-id="1b221-585">Product Offer Details:</span></span>

- <span data-ttu-id="1b221-586">Teklif adı: eğitim için sunucular için Microsoft Defender ATP</span><span class="sxs-lookup"><span data-stu-id="1b221-586">Offer name: Microsoft Defender ATP for Servers for Education</span></span>
- <span data-ttu-id="1b221-587">Teklif KIMLIĞI: c7b9ab7e-8f80-4b4b-8aed-dcad61f2899</span><span class="sxs-lookup"><span data-stu-id="1b221-587">Offer ID: c7b9ab7e-8f80-4b4b-8aed-dcad61f2899</span></span>

### <a name="next-steps"></a><span data-ttu-id="1b221-588">Sonraki adımlar</span><span class="sxs-lookup"><span data-stu-id="1b221-588">Next steps</span></span>

- <span data-ttu-id="1b221-589">Bu bilgileri, kuruluşunuzdaki uygun kişilerle paylaşabilirsiniz.</span><span class="sxs-lookup"><span data-stu-id="1b221-589">Share this information with the appropriate contacts in your organization.</span></span>
- <span data-ttu-id="1b221-590">Ürün hakkında daha fazla bilgi için [Microsoft Defender ATP belgelerini](/windows/security/threat-protection/microsoft-defender-atp/microsoft-defender-advanced-threat-protection) okuyun.</span><span class="sxs-lookup"><span data-stu-id="1b221-590">Read the [Microsoft Defender ATP documentation](/windows/security/threat-protection/microsoft-defender-atp/microsoft-defender-advanced-threat-protection) for more information about the product.</span></span>
