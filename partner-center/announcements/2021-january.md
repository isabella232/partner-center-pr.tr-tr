...
Dolaylı kurumsal Microsoft İş Ortağı Sözleşmesi (MPA) uygulama devam etmektedir. Destek sağlayıcılarını ve kurumsal bayileri daha fazla desteklemek için geri bildirimlerinizi aldık ve MPA'yı yeni bir Sık Sorulan Sorular sayfasında kabul etmeye yönelik yaygın sorguları [birleştirdik.](../mpa-indirect-provider-faq.yml)
...
**Dolaylı sağlayıcılar:** Dolaylı kurumsal bayileri ile etkileşime geçin ve CSP programı iş ortakları için Microsoft İş Ortağı Sözleşmesi (MPA) hakkında bilgi edinmek için [MPA SSS](../mpa-indirect-provider-faq.yml) ve adım adım kılavuzlarını kullanarak bunları [desteklenin.](../microsoft-partner-agreement.md)
...
________________
## <a name="partner-center-audit-log-changes-to-include-two-new-operation-types-for-dap"></a><a name="12"></a> İş Ortağı Merkezi dap için iki yeni İşlem Türü içerecek şekilde denetim günlüğü değişiklikleri yapın
...
- [Etkinlik kaydını İş Ortağı Merkezi - İş Ortağı Merkezi geliştirici | Microsoft Docs](/partner-center/develop/get-a-record-of-partner-center-activity-by-user)
- [Kaynakları denetleme - İş Ortağı Merkezi geliştirici kaynakları | Microsoft Docs](/partner-center/develop/auditing-resources)
...
- Kanallar arasında daha iyi fiyatlandırma hizalaması oluşturur. Müşteri ve iş ortağı geri bildirimlerine dayanarak, Bulut Çözümü Sağlayıcısı programı kapsamındaki yeni Azure deneyimi, müşterilere ve iş ortaklarına küresel ölçekte tutarlı fiyatlandırma sağlayarak tek bir fiyat listesi kullanır.
...
Yeni ticaret deneyimiyle iş ortakları, azure planı aracılığıyla azure hizmet planı kapsamındaki müşteriler için Azure Microsoft Müşteri Sözleşmesi üzerinden erişim elde eder. Bu plan, bir Azure planında birden çok Azure aboneliğinin oluşturulmasını sağlayarak satın alma deneyimini basitleştiriyor. Artık azure aboneliği başına ayrı bir sipariş göndermeniz İş Ortağı Merkezi.
...
Bulut Çözümü Sağlayıcısı programında (Azure planı) yeni Azure teklifini duyurup iş ortaklarına önceki Azure teklifinin ve platformunun yeni Azure deneyiminin yanı sıra bir süre daha kullanılabilir olmaya devam edeceğini ve bir önceki Azure teklifinde herhangi bir değişiklik olmadan önce iş ortaklarını altı ay önceden bilgilendireceğiz konusunda bilgilendirmıştık.
...
1 Şubat 2021'den başlayarak Government Community Cloud (GCC) ve GCC High müşterileri için üç yeni bileşen teklifi başlatacak. Bu SSU'lar şu anda Ticari'de kullanılabilen Microsoft 365 E5 Information Protection ve İdare, M365 E5 Insider Risk Management ve Microsoft 365 E5 eDiscovery & Audit ile eşdeğerdir. 

   |**Teklif adı**|**Teklif Kimliği**|**Malzeme Kimliği**|
   |-------------------|:------|:------|
   |Microsoft 365 E5 Information Protection İdare ve GCC|9e5397ab-f309-4d90-97f3-6fb5d53074d6|8QL-00002|
...
müşteriler, 1 şubat 2021 ' den itibaren, önde gelen çalışanlar için [Microsoft 365 F1 ve F3 sku 'larına](https://www.microsoft.com/microsoft-365/firstline-workers)eklentiler olarak üç yeni güvenlik ve uyumluluk programlama teklifi satın alabilir.
...
Bu programlı teklifler, **28 şubat 2021 '** de sona erecek geçerli [güvenlik ve uyumluluk](https://microsoft.sharepoint.com/teams/M365LicensingNews/SitePages/Security-and-Compliance-Promotion-for-Firstline-Workers-Update.aspx) promosyonu yerine geçecek. Geçerli yükseltmenin aksine, F5 eklentileri müşterilere saflarda işgücü büyüdükçe tahmin için daha öngörülebilirlik sağlar.
   ...
   |Microsoft 365 F5 Security & uyumluluğu|ad396924-ee4e-4059-b779-efe43dfa24d2|8RU-00003|
   
### <a name="next-steps"></a>Sonraki adımlar

Fiyat listesi önizlemesini gözden geçirin ve kuruluşunuzdaki uygun hissedarlarla paylaşabilirsiniz. Daha fazla bilgi için [Microsoft Güvenlik ve uyumluluk-Microsoft Tech Community](https://techcommunity.microsoft.com/t5/microsoft-security-and/ct-p/MicrosoftSecurityandCompliance)sayfasına gidin.
...
norveççe kronone kullanarak iş ortakları Bulut Çözümü Sağlayıcısı.
...
Deneyimidir içinde CSP iş ortakları.

### <a name="details"></a>Ayrıntılar 

Microsoft, Hindistan ve Asya bölgesi içindeki ticari yazılım ve çevrimiçi hizmetler fiyatlarını hizalamak için Hindistan Rupisi fiyat listesinde değişiklik yapıyor. Kullanılabilir hale geldiğinde daha fazla ayrıntı yayımlayacağız. Bu sırada yardıma ihtiyacınız varsa, [Iş Ortağı Merkezi desteğiyle](https://partner.microsoft.com/support/?stage=1)iletişim kurun.

________________

## <a name="calling-plan-and-phone-system-updates-for-february-1-2021"></a><a name="4"></a>1 şubat 2021 ' de Plan ve Telefon Sistemi güncelleştirmeleri çağrılıyor
...
Microsoft 365 için Telefon Sistemi ve yurtiçi çağrı planı ve tek başına yurtiçi çağrı planı dahil olmak üzere bir eklenti teklifi, çok yakında ülkeler arasından sunulacak.
...
Microsoft 365 E1, E3 ve E5 tekliflerini sağlayan eklenti için paketlenmiş teklif, Telefon Sistemi ve yurtiçi çağrı planını içerir. Ayrıca, yeni bir tek başına yurtiçi arama planı teklifi yalnızca E5 için kullanılabilir. Yeni teklifler yalnızca ABD, Porto Riko ve Kanada 'daki müşteriler tarafından kullanılabilir. diğer tüm ülkeler ve bölgeler için mevcut genel tek başına SKU 'Ları ve fiyatlandırma aynı kalır. 

bu teklifler, abd, porto riko ve kanada 'daki ticari, öğrenci, fakülte, Government Community Cloud (GCC) ve kar amacı olmayan müşteriler tarafından kullanılabilir. Çağırma planları, diğer ABD bölgelerinizin hiçbirinde kullanılamaz.

   |**Teklif adı**|**Teklif Kimliği**|**Malzeme KIMLIĞI**|
   |-------------------|:------|:------|
   |Microsoft Teams ABD ve Kanada için Essentials 'ı çağırma|1ee81de6-4D8B-4cf1-b926-2fd2a774a4ca|8N2-00010|
   |Microsoft Teams ABD ve Kanada için Essentials 'ı çağırma (kar amacı gütmeyen personel fiyatlandırması)|0c2ece0d-39b7-40ec-8c08-87c2b6c75d62|8N2-00011|
   |Microsoft Teams Öğretim üyeleri için ABD ve Kanada için Temel Bilgiler'i çağırma|b8baa3b8-8cc2-4f26-a212-7fbeb28e7895|8N3-00003|
   |Microsoft Teams Öğrenciler için ABD ve Kanada için Çağrı TemelLeri|26956da8-eeb5-44e3-aa79-d36e0e42b930|8N3-00004|
   |Microsoft Teams GCC için ABD ve Kanada için Temel GCC|7a2e2d5a-41b5-4b20-a0d1-0d06d34b5fe1|8N4-00002|
   |Microsoft 365 ABD ve Kanada için Yerel Arama Planı|60d2919e-427a-46c9-bd03-89cbad27d53f|TK2-00050|
   |Microsoft 365 ABD ve Kanada'daki fakülteler için Yerel Arama Planı|602e7548-375b-4e01-bf79-a9a8b8ff16d4|LM7-00006|
   |Microsoft 365 ABD ve Kanada için öğrenciler için Yerel Arama Planı|1f4b4375-3185-40cf-b044-117fe3b102c6|LM7-00007|
   |Microsoft 365 ABD ve Kanada için GCC Arama Planı|594ed84e-ddf8-4e40-9726-76c04bd29e3b|LM9-00023|

### <a name="next-steps"></a>Sonraki adımlar

- Bu bilgileri, kuruluşta ilgili kişilerle paylaşın ve satış ve çapraz satış fırsatlarını anlıyoruz. 
- İş Ortağı Kılavuzu'Teams [bölümünü gözden geçirme.](https://aka.ms/teamscallingmeetingsguide)

_____________ 

## <a name="license-base-price-list-updates-for-january-2021"></a><a name="3"></a>Ocak 2021 için lisans tabanı fiyat listesi güncelleştirmeleri 
...
Lisans tabanlı teklifler için Ocak ve Şubat fiyat listeleri, bazı hatalı liste fiyatlarını düzeltmek için güncelleştirildi.
...
Ocak 2021 ve Şubat 2021 için lisans tabanlı fiyat listelerinde birkaç yanlış liste fiyatı vardı. Etkilene teklifler ve para birimleri aşağıda verilmiştir. Doğru fiyatlandırma güncelleştirildi ve 7 Ocak 2021 14:00 PST (Pasifik Standart Saati) itibariyle kullanılabilir. 
...
Etkilene para birimleri: 

- Microsoft 365 E3 sorunları yalnızca şu para birimleriyle sınırlıydı: Japonca Yeni (JPY), Büyük İngiliz Poundu (GBP), Avrupa Birliği (EUR), Avustralya Doları (AUD). 
- Microsoft 365 İş Temel yalnızca Abd Doları (USD) Birleşik Devletler sınırlıydı. 

İş ortakları, doğru fiyatlar için şu anda kullanılabilir olan Ocak ve Şubat önizleme fiyat listelerine başvurmaktadır. 

### <a name="next-steps"></a>Sonraki adımlar

- İş ortaklarının düzeltilen Ocak ve Şubat fiyatlarını almak İş Ortağı Merkezi en son fiyat listesi dosyalarını indirmesi gerekir. 
- 1 Ocak ile 6 Ocak arasında abonelik satın alan kiracılardan etkilene kiracılar için genel yöneticilere, daha fazla ayrıntı içeren bir İş Ortağı Merkezi e-posta ile bilgi gönderilir. 

________________
## <a name="deprecation-and-retirement-of-existing-get-and-put-qualification-apis-for-the-education-customer-validation-process-by-the-end-of-february-2021"></a><a name="2"></a>Eğitim müşteri doğrulama işlemi için mevcut GET ve PUT Nitelik API'lerinin Şubat 2021 sonuna kadar kullanımdan çıkar ve kullanımdan çıkar

### <a name="impacted-audience"></a>Etkilene hedef kitle

İş Ortağı Merkezi API'sini kullanarak Bulut Çözümü Sağlayıcısı programı aracılığıyla Academic tekliflerini İş Ortağı Merkezi iş ortakları

### <a name="details"></a>Ayrıntılar 

Bu, Aralık 2020'de yayımlanan API geliştirmelerini takip eder. Aralık 2020'de yeni GET ve POST NitelikLER API'leri yayınlandı ve sonuç olarak eski GET ve PUT Nitelik API'leri Şubat 2021 sonuna kadar kaldırılamayacak. Bu sırada Eğitim tekliflerini satın almak için yeni GET ve POST İş Ortağı Merkezi API'lerini kullanabilirsiniz. 

### <a name="next-steps"></a>Sonraki adımlar

- Henüz bunu yapmadıysanız başarılı ve zamanında geçiş için yeni API'lere güncelleştirin.
- Yeni API İş Ortağı Merkezi gözden geçirme ve İşlem hazırlığı kaynaklarında [Kılavuz: İş Ortağı Merkezi Eğitim müşteri doğrulama süreci geliştirmeleri.](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements#/)
- Bu bilgileri, bu değişikliklere hazırlanmalarına yardımcı olmak için kuruluşta uygun ekiplerle ve kurumsal bayilerle paylaşın.

_____________

## <a name="dynamics-365-offers-for-february-2021"></a><a name="1"></a>Şubat 2021 için Dynamics 365 teklifleri
...
Yeni Dynamics 365 teklifi değişiklikleri Şubat 2021'de başlayacaktır.

### <a name="impacted-audience"></a>Etkilene hedef kitle

Bulut Çözümü Sağlayıcısı (CSP) doğrudan fatura ortağı, dolaylı sağlayıcı ve dolaylı kurumsal bayi teşvik programlarına katılan iş ortakları

### <a name="details"></a>Ayrıntılar

Microsoft, Şubat 2021'de başlayacak olan yeni Dynamics 365 teklifi değişikliklerini şu şekilde açıklar:

- Dynamics 365 Customer Voice Ek Yanıtı
- Dynamics 365 Müşteri Analizler Yaşam Sonu
- Dynamics 365 Cloud AX Geçişi Teklifi Kimlikleri değişikliği

**Dynamics 365 Customer Voice Ek Yanıtı**

1 Şubat 2021'de Microsoft, mevcut teklifi 1 Şubat 2021'de satışa sunacak olan 2 K'lık Anket Yanıtları ile değiştirmek için 1-K yanıt yetkilendirmesi ile yeni bir "Ek Yanıt" teklifi oluşturacak.

SKU ayrıntıları için [Dynamics CSP Offers-February 2021 Excel](https://partner.microsoft.com/resources/detail/dynamics-csp-offers-february-2021-xls) "Customer Voice Addl Resp" sekmesine bakın. Daha fazla [bilgi için Microsoft Dynamics 365 Müşteri Sesli Giriş](https://dynamics.microsoft.com/customer-voice/overview/) Sayfasını görüntüleme.

**Dynamics 365 Müşteri Analizler Yaşam Sonu**

1 Şubat 2021'de, aşağıdaki ürünler yaşam sonuna kadar değişecektir:

- Dynamics 365 Müşteri Hizmetleri Analizler ("Ek Durumlar dahil")
- Müşteri Hizmetleri için Dynamics 365 Sanal Aracısı

"Müşteri Hizmetleri Analizler" tek başına deneyimi, müşterilerin müşteri hizmetleri deneyimlerine derinden eklenmiş aynı özellikleri bularak "Dynamics 365 Müşteri Hizmetleri"ne taşınıyor.  

SKU ayrıntıları için Dynamics CSP Analizler [Offers-February 2021 Excel" sekmesine](https://partner.microsoft.com/resources/detail/dynamics-csp-offers-february-2021-xls) bakın. Daha fazla [bilgi için Microsoft Dynamics Müşteri Hizmetleri Giriş](https://dynamics.microsoft.com/customer-service/overview/) Sayfasını ziyaret edin.

**Dynamics 365 Cloud AX geçişi teklifi kimlikleri**

Bu SKUS'lar 1 Ocak 2021 son fiyat listesinden kaldırılmıştır ve şu anda sipariş için kullanılamaz. 
