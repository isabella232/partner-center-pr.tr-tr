...
________________
## <a name="partner-center-audit-log-changes-to-include-two-new-operation-types-for-dap"></a><a name="12"></a> İş Ortağı Merkezi dap için iki yeni İşlem Türü içerecek şekilde Denetim günlüğü değişikliklerini içerir
...
________________
## <a name="changes-to-azure-offer-availability-in-csp-related-to-the-new-commerce-experience-in-csp-for-azure"></a><a name="11"></a> CSP'de Azure teklifi kullanılabilirliği değişiklikleri, Azure için CSP'de yeni ticari deneyimle ilgili değişiklikler
...
Yeni ticaret deneyimiyle iş ortakları, azure planı aracılığıyla azure hizmetleriyle ilgili olarak hizmet kapsamındaki müşteriler için Microsoft Müşteri Sözleşmesi üzerinden erişim elde eder. Bu plan, bir Azure planında birden çok Azure aboneliğinin oluşturulmasını sağlayarak satın alma deneyimini basitleştiriyor. Artık azure aboneliği başına ayrı bir sipariş göndermeniz İş Ortağı Merkezi.
...
- [CSP'de Azure modüllerde iş ortağı tarafından kazanılan krediyle ilgili isteğe bağlı eğitim modülü (eventbuilder.com)](https://commercial_licensing.eventbuilder.com/NewcommerceinCSPforAzuretrainingmodules)
...
bir önkoşul Microsoft 365 E5 bulunan bir eklenti, müşterilerin verilerini 10 yıl boyunca tutmalarına olanak sağlar. 
   ...
   |**Teklif adı**|**Teklif Kimliği**|**Malzeme Kimliği**|
   |-------------------|:------|:------|
   |EDU için 10 Yıllık Denetim Günlüğü Saklama Ekleme|879b5e1a-eaa2-4ea9-a628-0b429b2e8732|8LC-00002|
   |10 Yıllık Denetim Günlüğü Saklama Ekleme|e14ce8d1-09f4-42d2-9b5e-ee85f32e7be4|8LB-00003|
...
## <a name="docusign-migration-to-adobe-sign-for-partners-under-microsoft-partner-agreements-mpas"></a><a name="7"></a>Microsoft İş Ortağı Anlaşmaları (MVA) kapsamındaki iş ortakları için Adobe Sign'a DocuSign geçişi 
...
Microsoft, tüm elektronik imza işleme işlemlerini DocuSign'tan Adobe Sign'a devredecek.
...
Şubat 2021'de Microsoft tüm elektronik imza işlemeyi DocuSign'tan CSP iş ortakları için Adobe Sign'a geçişe başlayacaktır. 

Sorunsuz bir geçiş beklemelisiniz. Geçişten sonra, elektronik imzanız gerektiğinde adobesign@adobesign.com DocuSign yerine 'den bir e-posta alırsınız. Bu e-posta size, imzalamanız gereken Adobe Sign web sayfasının bağlantısını sağlar. Microsoft iş ortaklarının mevcut anlaşmaları yeniden imzalaması, yalnızca gelecekteki Kanal Sözleşmelerini imzalaması gerekmektedir. 

Kaynak galerisinde Adobe Sign imza isteği e-postası örneği [bulabilirsiniz.](https://partner.microsoft.com/resources/detail/adobe-sign-signature-request-email-pdf) 

**En iyi deneyim için aşağıdaki adımları gerçekleştirin:**

1. Bu hesaptan gelen e-postaların doğrudan gereksiz e-posta klasörünüze girile adobesign@adobesign.com önlemesi için güvenli gönderenler listenize ekleyin.
2. Şunları yapmak için IT departmanınız ile birlikte çalışma:
   - Önceden kurulmuş bir kimlik avı kuralına dahil olmadığını emin olmak için e-posta adresini güvenli adobesign@adobesign.com gönderenler listesine ekleyin.
   - Tüm gerekli alıcıların Adobe Sign kurumsal lisansınız altında belgeleri imzalayamalarını sağlamak için mevcut güvenlik ilkelerini güncelleştirin.
...
## <a name="commercial-pricing-update-for-norwegian-krone"></a><a name="6"></a>Norveç kronu için ticari fiyatlandırma güncelleştirmesi 
...
1 Mart 2021'den itibaren, ticari şirket içi yazılım ve çevrimiçi hizmetler norveç kronu fiyatları, bölgedeki fiyatlandırma düzeyleriyle yeniden hizalanacak şekilde değişecektir.
Tam duyuru yalnızca Microsoft iş ortakları tarafından kullanılabilir. [Tam duyuruya erişmek için oturum açma.](https://partner.microsoft.com/resources/detail/pricing-update-norway-partners-pdf)
...
Hindistan'da işlem yapılan CSP iş ortakları.

### <a name="details"></a>Ayrıntılar 

Microsoft, Hindistan ve Asya bölgesi içindeki ticari yazılım ve yazılım fiyatlarına uygun çevrimiçi hizmetler Hint rupisi fiyat listesinde değişiklik yapıyor. Daha fazla ayrıntıyı kullanılabilir oldu mu yayımlayalarız. Bu arada yardıma ihtiyacınız varsa destek için [İş Ortağı Merkezi geçin.](https://partner.microsoft.com/support/?stage=1)
...
Bu teklifler TICARI, Öğrenci, Fakülteler, Government Community Cloud (GCC) ve ABD, Porto Riko ve Kanada'daki Kar Amacı Gütmeyen müşteriler tarafından kullanılabilir. Arama planları diğer ABD bölgelerinin hiçbirsinde kullanılamaz.
   ...
   |Microsoft 365 ABD ve Kanada için yurtiçi çağrı planı|60d2919e-427A-46c9-bd03-89cbad27d53f|TK2-00050|
   |Microsoft 365 ABD ve Kanada için Fakülteler için yurtiçi çağrı planı|602e7548-375b-4e01-bf79-a9a8b8ff16d4|LM7-00006|
   |Microsoft 365 ABD ve Kanada için öğrenciler için yurtiçi çağrı planı|1f4b4375-3185-40CF-b044-117fe3b102c6|LM7-00007|
   |Microsoft 365 abd ve kanada için GCC yurtiçi çağrı planı|594ed84e-ddf8-4E40-9726-76c04bd29e3b|LM9-00023|

### <a name="next-steps"></a>Sonraki adımlar

- Bu bilgileri kuruluşunuzdaki ilgili kişilerle paylaşıp, büyük satış ve çapraz satış fırsatlarını anlayın. 
- [Teams iş ortağı kılavuzunun](https://aka.ms/teamscallingmeetingsguide)kaynaklar bölümünü gözden geçirin.
...
iş ortağı merkezi apı 'sini kullanarak Bulut Çözümü Sağlayıcısı programı aracılığıyla akademik teklifler satan iş ortakları
...
- Dynamics 365 müşteri hizmeti Analizler ömür sonu
...
- Dynamics 365 müşteri hizmeti Analizler ("ek durumlar" da dahil)
- Müşteri Hizmetleri için Dynamics 365 sanal Aracısı

"müşteri hizmeti Analizler" tek başına deneyimi "Dynamics 365 müşteri hizmeti" ' ne taşınıyor. bu, müşterilerin müşteri hizmetleri deneyimlerinde derin gömülü yetenekleri bulabilecekleri "Dynamics müşteri hizmeti" ' ne  

SKU ayrıntıları için [Dynamics CSP Offers-February 2021 Excel belgesinde](https://partner.microsoft.com/resources/detail/dynamics-csp-offers-february-2021-xls) "müşteri hizmeti Analizler" sekmesine bakın. Daha fazla bilgi için [Microsoft Dynamics müşteri hizmeti giriş sayfasını](https://dynamics.microsoft.com/customer-service/overview/) ziyaret edin.
