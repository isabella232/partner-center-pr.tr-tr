...
Microsoft, Hindistan ve Asya bölgesi içindeki ticari yazılım ve çevrimiçi hizmetler fiyatlarını hizalamak için Hindistan Rupisi fiyat listesinde değişiklik yapıyor.

Tam duyuru yalnızca Microsoft Iş ortakları tarafından kullanılabilir. [Tam duyuruya erişmek Için oturum açın](https://partner.microsoft.com/resources/detail/price-update-indian-rupee.pdf).
...
Telefon sistemi ve yurtiçi çağrı planı ve tek başına yurtiçi arama planı dahil olmak üzere Microsoft 365 için bir eklenti teklifi, çok yakında ülkeler arasından sunulacak.
...
Microsoft 365 E1, E3 ve E5 tekliflerle ilgili eklenti için paketlenmiş teklif telefon sistemi ve yurtiçi çağrı planı dahil edilir. Ayrıca, yeni bir tek başına yurtiçi arama planı teklifi yalnızca E5 için kullanılabilir. Yeni teklifler yalnızca ABD, Porto Riko ve Kanada 'daki müşteriler tarafından kullanılabilir. diğer tüm ülkeler ve bölgeler için mevcut genel tek başına SKU 'Ları ve fiyatlandırma aynı kalır. 

Bu teklifler, ABD, Porto Riko ve Kanada 'daki ticari, öğrenci, fakülte, kamu Community bulutu (GCC) ve kar amacı olmayan müşteriler tarafından kullanılabilir. Çağırma planları, diğer ABD bölgelerinizin hiçbirinde kullanılamaz.

   |**Teklif adı**|**Teklif Kimliği**|**Malzeme KIMLIĞI**|
   |-------------------|:------|:------|
   |Microsoft ekipleri ABD ve Kanada için Essentials 'ı çağırıyor|1ee81de6-4D8B-4cf1-b926-2fd2a774a4ca|8N2-00010|
   |ABD ve Kanada için Essentials 'ı çağıran Microsoft ekipleri (kar amacı gütmeyen personel fiyatlandırması)|0c2ece0d-39b7-40ec-8c08-87c2b6c75d62|8N2-00011|
   |Microsoft ekipleri, Fakülteler için ABD ve Kanada için Essentials çağıran|b8baa3b8-8cc2-4f26-a212-7fbeb28e7895|8N3-00003|
   |Microsoft ekipleri ABD ve Kanada için Essentials çağıran öğrenciler|26956da8-eeb5-44E3-aa79-d36e0e42b930|8N3-00004|
   |Microsoft ekipleri ABD ve Kanada için Essentials çağıran GCC|7a2e2d5a-41B5-4b20-a0d1-0d06d34b5fe1|8N4-00002|
   |ABD ve Kanada için yurtiçi çağrı planını Microsoft 365|60d2919e-427A-46c9-bd03-89cbad27d53f|TK2-00050|
   |ABD ve Kanada için Fakülteler için yurtiçi çağrı planını Microsoft 365|602e7548-375b-4e01-bf79-a9a8b8ff16d4|LM7-00006|
   |ABD ve Kanada için öğrenciler için yurtiçi çağrı planını Microsoft 365|1f4b4375-3185-40CF-b044-117fe3b102c6|LM7-00007|
   |ABD ve Kanada için GCC için yurtiçi çağrı planını Microsoft 365|594ed84e-ddf8-4E40-9726-76c04bd29e3b|LM9-00023|
