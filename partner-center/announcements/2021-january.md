...
- CsP **Kalıcı yazılım fiyatı** listesini Fiyatlandırma ve Teklifler sayfasının Yazılım İş Ortağı Merkezi [&](https://partnercenter.microsoft.com/pcv/sales) indirin.  Yeni eklenen ürünlerin ve coğrafyaların listesi burada [bulunabilir.](https://partner.microsoft.com/resources/detail/software-in-csp-new-products-geos-pdf)
...
bu teklifler, abd, porto riko ve kanada 'daki ticari, öğrenci, fakülte, Government Community Cloud (GCC) ve kar amacı olmayan müşteriler tarafından kullanılabilir. Çağırma planları, diğer ABD bölgelerinizin hiçbirinde kullanılamaz.
   ...
   |Microsoft Teams Fakülteler için ABD ve Kanada için Temel Bilgiler'i çağırma|b8baa3b8-8cc2-4f26-a212-7fbeb28e7895|8N3-00003|
...
Lisans tabanlı tekliflerin Ocak ve Şubat fiyat listeleri, bazı hatalı liste fiyatlarını düzeltmek için güncelleştirildi.
...
Ocak 2021 ve Şubat 2021 için lisans tabanlı fiyat listeleri birkaç yanlış liste fiyatlarını içerir. Etkilene teklifler ve para birimleri aşağıda verilmiştir. Doğru fiyatlandırma güncelleştirildi ve 7 Ocak 2021 14:00 PST (Pasifik Standart Saati) itibariyle kullanılabilir. 
...
- 1 Ocak ile 6 Ocak arasında abonelik satın alan kiracılardan etkilene kiracılar için genel yöneticilere, daha fazla ayrıntı içeren İş Ortağı Merkezi e-posta ile bir e-posta gönderilir. 
...
İş Ortağı Merkezi API'sini kullanarak Bulut Çözümü Sağlayıcısı programı aracılığıyla Akademik İş Ortağı Merkezi satışları
...
- Yeni API değişikliklerini İş Ortağı Merkezi Ve İşlem hazırlığı kaynaklarında [Kılavuz: İş Ortağı Merkezi Eğitim müşteri doğrulama süreci geliştirmelerini gözden geçirebilirsiniz.](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements#/)
...
- Dynamics 365 Müşteri Hizmetleri Analizler Yaşam Sonu
...
"Müşteri Hizmetleri Analizler" tek başına deneyimi, müşterilerin müşteri hizmetleri deneyimlerine derinden eklenmiş olan aynı özellikleri bularak "Dynamics 365 Müşteri Hizmetleri"ne taşınıyor.  

SKU ayrıntıları için Dynamics CSP Analizler [Offers-February 2021 Excel](https://partner.microsoft.com/resources/detail/dynamics-csp-offers-february-2021-xls) "Customer Service Excel" sekmesine bakın. Daha fazla [bilgi için Microsoft Dynamics Müşteri Hizmetleri Giriş](https://dynamics.microsoft.com/customer-service/overview/) Sayfasını ziyaret edin.
