...
Bu güncelleştirme, Haziran ayının ortalarında kullanılabilir olacak.
...
2. aşama için iş ortağı eylemi gereklidir çünkü değişiklik mevcut ticari müşteri faturalarını etkiler.
...
- [Test özelliği artık kullanılabilir: Bulut Çözümü Sağlayıcısı müşteri adresi doğrulama API'sinde yapılan değişiklikler Haziran ayında yayınlanacak](https://partner.microsoft.com/resources/detail/testing-capability-for-csp-customer-address-validation-api-now-available-pdf)
...
Daha fazla bilgi edinmek için [İş Ortağı Merkezi'de referans içgörüleri edinin kılavuzumuza bakın.](/partner-center/referral-insights)
