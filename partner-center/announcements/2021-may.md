...
Temmuz 2021'in ortasından başlayarak Microsoft, CSP'de 1. aşamadan önce yeni bir ticaret teklifi satın alan mevcut müşteriler ve kiracıları 11 Mayıs 2020'den sonra oluşturulan müşteriler için yeni ticari tekliflerin faturasını müşteri konumu para biriminden iş ortağı konumu para birimine devredecek.
...
- Herhangi bir faturalama otomasyonu için Microsoft API'lerini veya üçüncü taraf denetim masası satıcısı (CPV) kullanan iş ortaklarının, müşterisi için para birimi değişikliğine uyum sağlamak için gerekli değişiklikleri yapmaları gerekir.

- İş Ortağı Merkezi veya Azure.com portal kullanıcı arabirimini (UI) kullanan iş ortaklarının 2. aşamadan sonra para birimi cinsinden değişiklik için hazırlanması gerekir.
...
Microsoft 365 Küçük İşletmeler için Ses Başlarken Sihirbazı (GSW) 1 Haziran 2021'de kaldırıyor ve yerine gelişmiş Teams Yönetim Merkezi deneyimi ve yeni kurulum belgeleri geliyor.
...
Microsoft 365 Küçük İşletmeler için Ses küçük ve orta ölçekli işletmelerin (SMB) iletişim kurma yolunu dönüştürmeye yardımcı olurken aynı zamanda verimliliği artırmaya, teknoloji yönetimini basitleştirmeye ve maliyet tasarrufuna da yardımcı oldu.
...
ABD, Birleşik Krallık veya Kanada'da iş ortağınız varsa ve Arama Planı ile İş [](/microsoftteams/business-voice/set-up-overview) Sesi satışını yaptısanız, business Voice'i ayarlama konusunda yardıma ihtiyaç duyacak müşterileri desteklemeye hazır olmak için yeni adım adım belgeleri (Microsoft 365 Küçük İşletmeler için Ses belge [hub'ını](/microsoftteams/business-voice/)kullanarak) tanımanız önerilir.
...
- [Test özelliği artık kullanılabilir: Müşteri Bulut Çözümü Sağlayıcısı doğrulama API'sinde yapılan değişiklikler Haziran'da yayınlanacak](https://partner.microsoft.com/resources/detail/testing-capability-for-csp-customer-address-validation-api-now-available-pdf)

#### <a name="csp-community-qa-reminder"></a>CSP Community Q&anımsatıcısı

Aylık CSP Community Soru&oturumu, programı etkileyen değişiklikler hakkında daha fazla bilgi edinmek ve sorular sormak için size bir fırsat sağlar. Bu ayın çağrısı, daha önce ele alan konulara ve daha birçok konuya odaklanacak.
