...
## <a name="windows-server-and-sql-server-subscriptions-available-to-cloud-solution-provider-csp-partners-in-russia-from-february-1-2020"></a><a id="7"/></a>Windows Sunucu ve SQL Server abonelikleri 1 Şubat 2020'den itibaren Bulut Çözümü Sağlayıcısı (CSP) iş ortakları tarafından kullanılabilir
...
- İş ortağı galerisi sayfasındaKI CSP programı kaynakları: Windows Server ve SQL Server için [Rusya'da CSP iş ortakları tarafından kullanılabilen abonelikler](https://partner.microsoft.com/resources/collection/geo-expansion-for-azure-reservations-and-server-subscriptions-for-windows-server-and-sql-server#/)
- [İş Ortağı Merkezi hakkında daha fazla bilgi İş Ortağı Merkezi](../azure-plan-get-started.md)
...
Microsoft, 7 Ocak 2020'den itibaren Meeting Room için Microsoft 365 F1 ve Toplantılar GCC. Daha fazla bilgi için fiyat listesine göz atabilirsiniz.
...
Microsoft, 7 Ocak 2020'den itibaren Meeting Room Microsoft 365 F1 için GCC'nin CSP GCC'da kullanılabilir olduğunu duyurmak için heyecanla duyurur.
...
Fiyat listesi hakkında bilgi edinin ve bu bilgileri, özellikle satış takımınız olmak üzere tüm ilgili kişilerle paylaşın.
...
Geri bildiriminizi sağlamak için zaman atarak tekrar teşekkür ederiz. Kuruluşların daha fazlasını başarmalarına yardımcı olmak için devam eden bir iş ortaklığına göz atacağız.
...
- Genişletme, daha sonra Birleşik Devletler coğrafi bölgelere genişletilen müşterilerle başlar.
...
- PowerShell betiği artık IT Yöneticileri tarafından kullanılabilir. Microsoft Flow güncelleştirme tarihi: Power Automate: 19 Kasım 2019.
- Power BI, Power Apps ve diğer ülkeler için self servis Power Automate satın alma başlatma ve başlatma ayrıntıları: - 14 Ocak 2020
- Power Apps ve Power Automate için self servis satın alma başlatma: 28 Ocak 2020

_________________

## <a name="announcing-a-new-reporting-dashboard-beta-in-partner-center"></a><a id="4"/></a>İş Ortağı Merkezi'da yeni bir raporlama panosu (beta) İş Ortağı Merkezi
...
İş Ortağı Merkezi'da yeni bir raporlama panosu (beta) İş Ortağı Merkezi

### <a name="summary"></a>Özet

Kuruluşa üye olan iş ortağı kuruluşlara İş Ortağı Merkezi yeni bir birleşik raporlama panosu Microsoft İş Ortağı Ağı. Bu pano aracılığıyla, Office 365, Azure, Dynamics 365 gibi bulut ürünleri ve Bulut Çözümü Sağlayıcısı (CSP) ve Kurumsal Anlaşma (EA) gibi lisanslama modelleri genelinde iş ortağı kuruluşlarının ana performans göstergelerinin (KPI) birleşik, 360 derecelik bir görünümüne erişebilirsiniz. Akıllı içgörüler, Microsoft ile işlerinizi net bir şekilde anlamanız ve güvenle veri odaklı kararlar alasınız.
...
- Erişim, Analizler, rapora genel bakış ve &, geri bildirim bırakma ve daha fazlasını kapsayan tüm kaynakları gözden geçirme: İş Ortağı Merkezi'de yeni bir [raporlama panosu (beta) İş Ortağı Merkezi](https://partner.microsoft.com/resources/collection/partner-center-insights-reporting-dashboard#/)
...
## <a name="action-required-remember-to-confirm-the-acceptance-of-microsoft-customer-agreement-by-january-31-2020"></a><a id="3"/></a>Eylem gerekiyor: 31 Ocak 2020'ye kadar Microsoft Müşteri Sözleşmesi onaylayın
