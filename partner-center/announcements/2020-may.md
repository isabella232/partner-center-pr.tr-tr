...
Aşağıdaki kaynaklara başvurarak aşağıdaki kaynaklara çevrimiçi hizmetler:
...
SPA iş ortağıysanız PSBC aracılığıyla İşlemler'e [bir olay](https://mbs2.microsoft.com/Support/OperationsIncidents.aspx?Mode=Create&t=1588193289962) gönderabilirsiniz. SPA iş ortağınız (PSBC'ye erişimi yoksa) müşterinizin ülke konumuna göre aşağıdaki e-posta adreslerinden biri için servis talebi gönderebilirsiniz:
