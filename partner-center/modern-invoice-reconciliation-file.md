...
| CustomerCountry | Müşterinizin bulunduğu ülke. Bölgeniz için [ülkelerin tam listesini](/partner-center/regional-authorization-overview) görüntüleyin.  | *DE* |
| Faturanumarası | Mutabakat dosyası ile ilişkili fatura numarası.  | *G002297372* |
| Mpnıd | CSP iş ortağının MPN tanımlayıcısı. Daha fazla bilgi için bkz. [iş ortağı tarafından nasıl yapılır](/partner-center/use-the-reconciliation-files#itemize-reconciliation-files-by-partner). | *6034453* |
...
| ChargeType | Ücret veya ayarlamanın [türü](/partner-center/recon-file-charge-types) . | *Yeni* |
...
| Efekt, BirimFiyat | Fatura döngüsünün maliyetini hesaplamak için eşit olarak dağıtılmış birim fiyatı. İndirimler, faturalandırma günlerindeki ayarlamalar ve diğer faktörler, geçerli birim fiyatını belirlemektir. Daha fazla bilgi için bkz. [geçerli birim fiyat hesaplaması](/partner-center/effective-unit-price-calculation).  | *0,03825* |
...
| Rezervno | Rezervasyon sipariş kimliği. | *E21A6344E398FFC1C4D7...* |
