...
bu rapora İş Ortağı Merkezi [için](https://partner.microsoft.com/dashboard)Hesap ayarları Güvenlik **Ayarlar**  >    >  **durumuna gidin.** Rapor günlük olarak güncelleştirilir ve son yedi günün oturum açma verilerini yansıtıyor.
...
Çalışanlarınız çalışmak için İş Ortağı Merkezi API'ler aracılığıyla veri almak veya göndermek için her oturum İş Ortağı Merkezi durumlarıyla ilgili güvenlik durumları isteniyor ve takip ediyor. Ayrıca, uygulamalarınız ve denetim masası satıcı uygulamaları, güvenlik durumu izlemesine de dahildir. Bu veriler, **MFA** ile İş Ortağı Merkezi yüzdesi altındaki ölçümlerde gösterilir ve son yedi günü yansıtıyor.
...
API veya **SDK aracılığıyla ölçüm,** API istekleri aracılığıyla App+User İş Ortağı Merkezi ile ilgilidir. MFA talebiyle erişim belirteci kullanılarak yapılan API isteklerinin yüzdesini ölçür. Örnek:
...
- [İş Ortağı Merkezi güvenlik gereksinimleri hakkında SSS](partner-security-requirements-faq.yml)
