...
Iş Ortağı Merkezi 'nden beceriler raporu verilerini görüntülemek için aşağıdaki adımları izleyin.
...
3. Yetenekler sayfasının sağ üst kısmında bulunan aşağıdaki seçenekleri bulun:  **Uzmanlıklar performans raporu** ve **indirme becerileri raporu**. Iş Ortağı Merkezi Kullanıcı arabirimindeki veya indirilen bir elektronik tabloda yetenek raporu verilerini görüntüleme seçeneğiniz vardır.
   ...
   - Raporu elektronik tablo biçiminde indirmek için, **yetenek raporunu indir**' i seçin. Dosya indirildikten ve açıldıktan sonra, her kullanıcının becerileriyle ilgili ayrıntıların bulunduğu bir tablo görürsünüz. **PMC** ve **PC ile ilişkili** olan sütunlar, Kullanıcı becerilerinin daha önce iş ortağı üyelik Merkezi (PMC) hesabıyla ve Iş Ortağı Merkezi (PC) hesabıyla zaten ilişkilendirilmiş olup olmadığını gösterir. Hala PMC 'de çalışan kullanıcılarınız varsa, PMC kullanıcıları üzerindeki sonraki bölüme bakın.
...
Yetenek raporunu indirmeye çalıştığınızda, *"beceriler verileriyle Kullanıcı bulunamadı" iletisini görebilirsiniz. Kullanıcıların öğrenimini veya Iş ortağı Üniversitesi hesaplarını profillerle ilişkilendirip ilişkilendirmediğini denetleyin.*
...
Kullanıcılarınızın [öğrenimi](ms-learn-associate.md) veya Iş ortağı Üniversitesi hesaplarıyla Ilişkili MCPs 'Lerin Iş Ortağı Merkezi 'ndeki Kullanıcı hesaplarıyla zaten ilişkili olup olmadığını denetleyin.
