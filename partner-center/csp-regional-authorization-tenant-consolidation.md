...
3. **Satıcı Ilişkisi iste** ' ye tıklayın. Müşterilerinize göndermek için varsayılan bir e-posta iletisi sunulur. Bu ileti, yeni Iş Ortağı Merkezi hesabınıza özel kuruluş KIMLIĞINE sahip bir URL içerir.
...
> [!NOTE]
> İş ortakları, iş ortağı Merkezi **'nde iş ortağı** kiracı hesabından geçiş sırasında abonelikleri askıya almalıdır. bu abonelikler, Çift faturalandırma işleminin gerçekleşmemesini sağlamak için Iş Ortağı Merkezi 'nde **iş ortağı kiracı** hesabı altına geçirilir ve ayarlanır. Aboneliklerden geçiş işleminin doğru şekilde devre dışı bırakılmasından kaynaklanan bir çakışma nedeniyle, destek istekleri krediler için **Transitioning From** reddedilir.
...
3. Aboneliği **askıya alındı** olarak ayarlayın ve ardından **Gönder** ' e tıklayın.
...
Office 365 CSP aboneliklerinden farklı olarak, Azure, kullanım tabanlı CSP aboneliklerinin el ile geçirilmesi gerekmez. Microsoft Azure desteği, Azure aboneliklerini, ayrıca CSP satıcı hesaplarından **alınan** tüm hizmet veya kaynakları **, CSP satıcısı** hesabına geçiş yapmak için geçirilecek. Bu geçiş sırasında müşteriye hizmet kesintisi olmaz.
...
1. Müşterilerin listesini görmek için Iş Ortağı Merkezi ' nde **müşteriler** ' e tıklayın. 

2. İstenen müşteri adını açın.

3. **Abonelikler sayfasında,** aboneliklerin ayrıntılarını bir Excel dosyasına dışarı aktarmak Için **abonelikleri dışarı aktar** ' a tıklayın.
